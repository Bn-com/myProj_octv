...
sys.path.append(ur'Z:\Resource\Groups\Studio_FantasyImage\TD\a2_work_proj\scripts')
from Other.studio_a2.scripts import ui_cam_shk_lib_oneButton

reload(ui_cam_shk_lib_oneButton)
def getMayaWindow():
...
class CamSkLibMayaWindow(QtGui.QMainWindow):
    def __init__(self, parent=getMayaWindow()):
        ...
        self.ui = ui_cam_shk_lib_oneButton.Ui_MainWindow()
        self.ui.setupUi(self)
        self.shk_cams_dir = ur'Z:\Resource\Groups\Studio_FantasyImage\TD\a2_work_proj\other'
        # Connection
        self.ui.im_bt1.clicked.connect(self.xxx)
