...
def zd_getAudioAndCam( audio = True):
    ...
    if snEP == 'VV':
        ...
        path = 'Z:/Projects/ZoomWhiteDolphin/Reference/Animation_production/'
    
        eps = os.listdir('Z:/Projects/ZoomWhiteDolphin/Reference/Animation_production/005_CF_Ylva_in_Charge/Layout_exports/CF010/0230/v001/camera/')
        eps = os.listdir(path)
