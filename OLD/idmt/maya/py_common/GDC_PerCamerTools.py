...
#
    ...
    def nj_ChangeReSets(self):
        ...
        intField("TheNumber",e=1, value=len(TheDateLib),cc="from idmt.maya.py_common import GDC_PerCamerTools\nreload(GDC_PerCamerTools)\nGDC_PerCamerTools.nj_HbExceptCam('nj').nj_ChangeReSets4()" )    
        ...
        try:
            ...
            for j in range(len(Thejpg)):
                    theCommand='from idmt.maya.py_common import GDC_PerCamerTools\nreload(GDC_PerCamerTools)\nGDC_PerCamerTools.nj_HbExceptCam("nj").nj_ImportReCam(\"'+Thejpg[j]+'\")'
                    theCommand2='from idmt.maya.py_common import GDC_PerCamerTools\nreload(GDC_PerCamerTools)\nGDC_PerCamerTools.nj_HbExceptCam("nj").nj_ImageOk(\"'+Thejpg[j]+'\")'
                    theCommand3='from idmt.maya.py_common import GDC_PerCamerTools\nreload(GDC_PerCamerTools)\nGDC_PerCamerTools.nj_HbExceptCam("nj").nj_CancleHook(\"'+Thejpg[j]+'\")'
    ...
    def nj_ChangeReSets4(self):
        ...
        try:
            ...
            for j in range(len(Thejpg)):
                    ...
                    theCommand2='from idmt.maya.py_common import GDC_PerCamerTools\nreload(GDC_PerCamerTools)\nGDC_PerCamerTools.nj_HbExceptCam("nj").nj_ImageOk(\"'+Thejpg[j]+'\")'
                    theCommand3='from idmt.maya.py_common import GDC_PerCamerTools\nreload(GDC_PerCamerTools)\nGDC_PerCamerTools.nj_HbExceptCam("nj").nj_CancleHook(\"'+Thejpg[j]+'\")'
                    iconTextButton("Temp"+str(j) ,e=1,visible=1,bgc=(1,1,1),style='iconAndTextVertical', image1=self.camPath+questEP+"/"+questSets+"/"+"/"+questSets+"/images/"+Thejpg[j], label=Thejpg[j].split(".")[0],c=theCommand )
                    menuItem("TheObMenu"+str(j),e=1,l="This Camera is ok",c=theCommand2 )
                    menuItem("Cancle"+str(j),e=1,l="cancle the hook",c=theCommand3 )
    ...
    def nj_SkReCamToolsUI(self):
        ...
        optionMenu( "EP",label='EP',cc="from idmt.maya.py_common import GDC_PerCamerTools\nreload(GDC_PerCamerTools)\nGDC_PerCamerTools.nj_HbExceptCam('nj').nj_ChangeReSets3()" )
        if self.pro=='nj':
    ...
    #        menuItem( 'C'+i,label='C'+i)
        ...
        optionMenu( "EPNUM",label='SETS',cc="from idmt.maya.py_common import GDC_PerCamerTools\nreload(GDC_PerCamerTools)\nGDC_PerCamerTools.nj_HbExceptCam('nj').nj_ChangeReSets()" )
        TheFileList=getFileList( folder=self.camPath+questEP+"/" )
        for m in range(1000):
        ...
        button("OKBUTTON",l = "export all cam", c = "from idmt.maya.py_common import GDC_PerCamerTools\nreload(GDC_PerCamerTools)\nGDC_PerCamerTools.nj_HbExceptCam('nj').nj_ExceptReCam()")
    
        button("OKBUTTON02",l = "exp selected cam", c = "from idmt.maya.py_common import GDC_PerCamerTools\nreload(GDC_PerCamerTools)\nGDC_PerCamerTools.nj_HbExceptCam('nj').nj_ExceptSelectReCam()")
        button("OKBUTTON03",l = "open path", c = "from idmt.maya.py_common import GDC_PerCamerTools\nreload(GDC_PerCamerTools)\nGDC_PerCamerTools.nj_HbExceptCam('nj').nj_OpenReCamPath()")
        intField("TheNumber", value=100,cc="from idmt.maya.py_common import GDC_PerCamerTools\nreload(GDC_PerCamerTools)\nGDC_PerCamerTools.nj_HbExceptCam('nj').nj_ChangeReSets4()" )
        ...
        textScrollList("TheDateLibSc",w=128,h=600,allowMultiSelection=True,numberOfRows=8,selectCommand="from idmt.maya.py_common import GDC_PerCamerTools\nreload(GDC_PerCamerTools)\nGDC_PerCamerTools.nj_HbExceptCam('nj').nj_ChangeColor()")
        setParent("..")
