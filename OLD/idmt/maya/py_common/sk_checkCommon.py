...
class sk_checkTools(object):
    ...
    def sk_sceneUICheckTools(self):
        ...
        mc.textField('sk_sceneUICheckName', w=300, h=30, en=1, text=(unicode('输入整行然后按【提取选择】按钮', 'utf8')))
        mc.button(w=100, h=30, bgc=[0, 0.5, 0.8], label=(unicode('【提取选择】', 'utf8')),
                  c='sk_checkCommon.sk_checkTools().sk_sceneDetailsSelectObject()')
        mc.setParent("..")

        # 行按钮
        mc.rowLayout(numberOfColumns=2, columnWidth2=(150, 250))
        # 全自动
        mc.button(w=150, h=350, bgc=[0, 0.5, 0.2], label=(unicode('【全自动】【Check】', 'utf8')),
                  c='sk_checkCommon.sk_checkTools().checkModelDetailsWarning()')
        mc.columnLayout()
        # 分割按钮
        # 第1排
        mc.rowLayout(numberOfColumns=2, columnWidth2=(125, 125))
        mc.button(w=125, h=30, bgc=[0, 0.4, 0.1], label=(unicode('【Check】【参考】          ', 'utf8')),
                  c='sk_checkCommon.sk_checkTools().checkModelDetailsWarning(\"refCheck\")')
        mc.button(w=125, h=30, bgc=[0, 0.4, 0.7], label=(unicode('<<自动更新标记Set>>', 'utf8')),
                  c='sk_checkCommon.sk_checkTools().checkCacheSetAdd()\nsk_checkCommon.sk_checkTools().checkTransAnimSetAdd()\nfrom idmt.maya.py_common import sk_sceneConfig\nreload(sk_sceneConfig)\nsk_sceneConfig.sk_sceneConfig().sk_sceneCacheAnimSetConfig(\"Cache\",\"ZM\")\nsk_sceneConfig.sk_sceneConfig().sk_sceneCacheAnimSetConfig(\"Anim\",\"ZM\")')
        mc.setParent("..")
        # 第2排
        mc.rowLayout(numberOfColumns=2, columnWidth2=(125, 125))
        mc.button(w=125, h=30, bgc=[0, 0.4, 0.1], label=(unicode('【Check】【namespace】', 'utf8')),
                  c='sk_checkCommon.sk_checkTools().checkModelDetailsWarning(\"nsCheck\")')
        mc.button(w=125, h=30, bgc=[0, 0.4, 0.7], label=(unicode('<<namespace工具>>', 'utf8')),
                  c='mel.eval(\"common_namespaceTools\")')
        mc.setParent("..")
        # 第3排
        mc.rowLayout(numberOfColumns=2, columnWidth2=(125, 125))
        mc.button(w=125, h=30, bgc=[0, 0.4, 0.1], label=(unicode('【Check】【命名】          ', 'utf8')),
                  c='sk_checkCommon.sk_checkTools().checkModelDetailsWarning(\"MSHCheck\")')
        mc.button(w=125, h=30, bgc=[0, 0.4, 0.7], label=(unicode('<<选取添加_后缀>>', 'utf8')),
                  c='sk_checkCommon.sk_checkTools().checkRenameMSHPosfix()')
        mc.setParent("..")
        # 第4排
        mc.rowLayout(numberOfColumns=2, columnWidth2=(125, 125))
        mc.button(w=125, h=30, bgc=[0, 0.4, 0.1], label=(unicode('【Check】【面数】          ', 'utf8')),
                  c='sk_checkCommon.sk_checkTools().checkModelDetailsWarning(\"faceCheck\")')
        mc.button(w=125, h=30, bgc=[0, 0.4, 0.7], label=(unicode('<<自动处理重命名>>', 'utf8')),
                  c='sk_checkCommon.sk_checkTools().checkSameRename()\nsk_checkCommon.sk_checkTools().checkSameRename(\"mesh\")\nsk_checkCommon.sk_checkTools().checkSameRename(\"nurbsCurve\")\nsk_checkCommon.sk_checkTools().checkMSHKeepOneRename(\"MSH\")')
        mc.setParent("..")
        # 第5排
        mc.rowLayout(numberOfColumns=2, columnWidth2=(125, 125))
        mc.button(w=125, h=30, bgc=[0, 0.4, 0.1], label=(unicode('【Check】【instance】    ', 'utf8')),
                  c='sk_checkCommon.sk_checkTools().checkModelDetailsWarning(\"insCheck\")')
        mc.button(w=125, h=30, bgc=[0, 0.4, 0.7], label=(unicode('<<displaceLayer清理>>', 'utf8')),
                  c='sk_checkCommon.sk_checkTools().checkCleanDisplayLayers()')
        mc.setParent("..")
        # 第6排
        mc.rowLayout(numberOfColumns=2, columnWidth2=(125, 125))
        mc.button(w=125, h=30, bgc=[0, 0.4, 0.1], label=(unicode('【Check】【smooth】     ', 'utf8')),
                  c='sk_checkCommon.sk_checkTools().checkModelDetailsWarning(\"smoothCheck\")')
        mc.button(w=125, h=30, bgc=[0, 0.4, 0.7], label=(unicode('<<renderLayer清理>>', 'utf8')),
                  c='sk_checkCommon.sk_checkTools().checkCleanRenderLayers()')
        mc.setParent("..")
        # 第7排
        mc.rowLayout(numberOfColumns=2, columnWidth2=(125, 125))
        mc.button(w=125, h=30, bgc=[0, 0.4, 0.1], label=(unicode('【Check】【标记】         ', 'utf8')),
                  c='sk_checkCommon.sk_checkTools().checkModelDetailsWarning(\"signCheck\")')
        mc.button(w=125, h=30, bgc=[0, 0.4, 0.7], label=(unicode('<<自动清理空组>>', 'utf8')),
                  c='mel.eval(\"deleteEmptyGroups()\")')
        mc.setParent("..")
        # 第8排
        mc.rowLayout(numberOfColumns=2, columnWidth2=(125, 125))
        mc.button(w=125, h=30, bgc=[0, 0.4, 0.1], label=(unicode('【Check】【物体重名】  ', 'utf8')),
                  c='sk_checkCommon.sk_checkTools().checkModelDetailsWarning(\"sameTransformCheck\")')
        mc.button(w=125, h=30, bgc=[0, 0.4, 0.7], label=(unicode('<<显示|隐藏骨骼>>', 'utf8')),
                  c='sk_checkCommon.sk_checkTools().checkJointViewHide()')
        mc.setParent("..")

        # 第9排
        mc.rowLayout(numberOfColumns=2, columnWidth2=(125, 125))
        mc.button(w=125, h=30, bgc=[0, 0.4, 0.1], label=(unicode('【Check】【shape重名】', 'utf8')),
                  c='sk_checkCommon.sk_checkTools().checkModelDetailsWarning(\"sameShapeCheck\")')
        mc.button(w=125, h=30, bgc=[0.1, 0.1, 0.1], label=(unicode('<<添加|ct_an标记>>', 'utf8')),
                  c='sk_checkCommon.sk_checkTools().checkCTANSignAdd()')
        mc.setParent("..")

        # 第10排
        mc.rowLayout(numberOfColumns=2, columnWidth2=(125, 125))
        mc.button(w=125, h=30, bgc=[0, 0.4, 0.1], label=(unicode('【Check】【Mesh同名】', 'utf8')),
                  c='sk_checkCommon.sk_checkTools().checkModelDetailsWarning(\"sameShapeNodeCheck\")')
        mc.button(w=125, h=30, bgc=[0, 0.4, 0.1], label=(unicode('【Check】【proxy位移】', 'utf8')),
                  c='sk_checkCommon.sk_checkTools().checkModelDetailsWarning(\"proxyInfo\")')
        mc.setParent("..")

        # 第11排
        mc.rowLayout(numberOfColumns=2, columnWidth2=(125, 125))
        mc.button(w=125, h=30, bgc=[0, 0.4, 0.1], label=(unicode('【Check】【smoothSet】', 'utf8')),
                  c='sk_checkCommon.sk_checkTools().checkModelDetailsWarning(\"smoothSet\")')
        mc.button(w=125, h=30, bgc=[0, 0.4, 0.1], label=(unicode('【Check】【renderState】', 'utf8')),
                  c='sk_checkCommon.sk_checkTools().checkModelDetailsWarning(\"renderState\")')
        mc.setParent("..")
    ...
    # 获取重名
    def checkSameName(self, nodeType='transform'):
        # translate处理
                    ...
                    for jIndex in keyMaxIndex:
                        ...
                        if doRename:
                            ...
                            if shape:
                                # 重命名
                                # mesh类,nurbs及细分类
                                if mc.nodeType(shape[0]) == 'mesh' or mc.nodeType(
                                        shape[0]) == 'nurbsSurface' or mc.nodeType(shape[0]) == 'subdiv':
                        ...
                        try:
                            ...
                            if faceNum:
                                for i in range(faceNum):
                                    # 获取面的点
                                    pointInfo = list(set(
                                        mc.polyInfo((grp + '.f[' + str(i) + ']'), faceToVertex=1)[0].split(':')[
                                            1].split(' ')))
    ...
    def checkModelSmoothSet(self, projType):
        ...
        if smoothSetCheck == 0:
            # 检测是否有货
            smoothObjs = sk_smoothSet.sk_smoothSetTools().smoothSetGetObjects(
                0) + sk_smoothSet.sk_smoothSetTools().smoothSetGetObjects(
                1) + sk_smoothSet.sk_smoothSetTools().smoothSetGetObjects(2)
            errorInfo = []
            if smoothObjs:
                needSmoothObjs = []
                    ...
                    if mc.listRelatives(obj, c=1, ni=1, type='mesh', f=1):
                        if not (obj + '.MoA'):
                            ...
                            for attr in attrs:
                                ...
                                isLock = mc.getAttr(mesh + attr, lock=True)
                                if state == 0 and not isLock:
                                    checkState = 1
                                    break
                            if checkState:
                                if '_si_' not in obj and '_nr_' not in obj and '_proxy_' not in obj and ':' not in obj:
    ...
    def checkTransparencyObjsInfoExport(self):
                    ...
                    if mc.nodeType(shaderNode[0]) == 'layeredShader':
                        ...
                        if layerInputs:
                            for inputNum in layerInputs:
                                transpancyNode = ''
                                transpancyAttr = mc.ls(
                                    shaderNode[0] + '.inputs[' + str(inputNum) + ']' + '.transparency')
                                transpancyNode = mc.listConnections(transpancyAttr[0], plugs=1, connections=1,
                                                                    destination=0)
                                if transpancyNode:
                        ...
                        if mc.nodeType(shaderNode[0]) == 'rampShader':
                            ...
                            for inputNum in transList:
                                transpancyNode = ''
                                transpancyAttr = mc.ls(
                                    shaderNode[0] + '.transparency[' + str(inputNum) + ']' + '.transparency_Color')
                                transpancyNode = mc.listConnections(transpancyAttr[0], plugs=1, connections=1,
                                                                    destination=0)
                                if transpancyNode:
        ...
        localTransPath = localPath + 'transShaderInfo/' + shotInfo[0] + '/' + str(shotInfo[1]) + '/' + str(
            shotInfo[2]) + '/'
        mc.sysFile(localTransPath, makeDir=1)
        serverTransPath = serverPath + 'data/AssetInfos/transShaderInfo/' + shotInfo[0] + '/' + str(
            shotInfo[1]) + '/' + str(shotInfo[2]) + '/'
        ...
        updateAnimCMD = 'zwSysFile "copy" ' + '"' + (localTransPath + 'transSGNodes.txt') + '"' + ' ' + '"' + (
        serverTransPath + 'transSGNodes.txt') + '"' + ' true'
        mel.eval(updateAnimCMD)
        sk_infoConfig.sk_infoConfig().checkFileWrite((localTransPath + 'transMeshes.txt'), transpancyMeshes)
        updateAnimCMD = 'zwSysFile "copy" ' + '"' + (localTransPath + 'transMeshes.txt') + '"' + ' ' + '"' + (
        serverTransPath + 'transMeshes.txt') + '"' + ' true'
        mel.eval(updateAnimCMD)
        sk_infoConfig.sk_infoConfig().checkFileWrite((localTransPath + 'transNodes.txt'), transpancyNode)
        updateAnimCMD = 'zwSysFile "copy" ' + '"' + (localTransPath + 'transNodes.txt') + '"' + ' ' + '"' + (
        serverTransPath + 'transNodes.txt') + '"' + ' true'
        mel.eval(updateAnimCMD)
    ...
    def checkDisplacementObjsInfoExport(self):
        ...
        localPath = sk_infoConfig.sk_infoConfig().checkLocalInfoPath()
        serverPath = sk_infoConfig.sk_infoConfig().checkProjectServerPath()
        localTransPath = localPath + 'displacementShaderInfo/' + shotInfo[0] + '/' + str(shotInfo[1]) + '/' + str(
            shotInfo[2]) + '/'
        mc.sysFile(localTransPath, makeDir=1)
        serverTransPath = serverPath + 'data/AssetInfos/displacementShaderInfo/' + shotInfo[0] + '/' + str(
            shotInfo[1]) + '/' + str(shotInfo[2]) + '/'
        makeDirCMD = 'zwSysFile(\"MD\",\"' + serverTransPath + '\",\"\",1)'
        mel.eval(makeDirCMD)

        # 本地输出及更新
        sk_infoConfig.sk_infoConfig().checkFileWrite((localTransPath + 'displacementSGNodes.txt'),
                                                     displacementSGNodesAll)
        updateAnimCMD = 'zwSysFile "copy" ' + '"' + (localTransPath + 'displacementSGNodes.txt') + '"' + ' ' + '"' + (
        serverTransPath + 'displacementSGNodes.txt') + '"' + ' true'
        mel.eval(updateAnimCMD)
        sk_infoConfig.sk_infoConfig().checkFileWrite((localTransPath + 'displacementMeshes.txt'), displacementMeshesAll)
        updateAnimCMD = 'zwSysFile "copy" ' + '"' + (localTransPath + 'displacementMeshes.txt') + '"' + ' ' + '"' + (
        serverTransPath + 'displacementMeshes.txt') + '"' + ' true'
        mel.eval(updateAnimCMD)
        sk_infoConfig.sk_infoConfig().checkFileWrite((localTransPath + 'displacementNodes.txt'), displacementNodesAll)
        updateAnimCMD = 'zwSysFile "copy" ' + '"' + (localTransPath + 'displacementNodes.txt') + '"' + ' ' + '"' + (
        serverTransPath + 'displacementNodes.txt') + '"' + ' true'
        mel.eval(updateAnimCMD)
    ...
    def checkCacheSetAdd(self):
        ...
        if nodes:
            ...
            print (u'CacheList    ' + str(len(CacheObjs)))
    ...
    def checkAssetSmoothSetUpdate(self):
        ...
        serverInfoPath = serverPath + 'data/AssetInfos/smoothSetInfo/' + shotInfo[0] + '/' + shotInfo[1] + '/' + \
                         shotInfo[2] + '/'
        ...
        updateAnimCMD = 'zwSysFile "copy" ' + '"' + (localInfoPath + 'smooth_0.txt') + '"' + ' ' + '"' + (
        serverInfoPath + 'smooth_0.txt') + '"' + ' true'
        mel.eval(updateAnimCMD)
        self.checkFileWrite((localInfoPath + 'smooth_1.txt'), smoothObjs_lv1)
        updateAnimCMD = 'zwSysFile "copy" ' + '"' + (localInfoPath + 'smooth_1.txt') + '"' + ' ' + '"' + (
        serverInfoPath + 'smooth_1.txt') + '"' + ' true'
        mel.eval(updateAnimCMD)
        self.checkFileWrite((localInfoPath + 'smooth_2.txt'), smoothObjs_lv2)
        updateAnimCMD = 'zwSysFile "copy" ' + '"' + (localInfoPath + 'smooth_2.txt') + '"' + ' ' + '"' + (
        serverInfoPath + 'smooth_2.txt') + '"' + ' true'
        mel.eval(updateAnimCMD)
    ...
    def checkAnim2RenderSetUI(self):
        ...
        mc.columnLayout()
        mc.optionMenuGrp('sk_checkAnim2RenderCheckType', label=(unicode('检测Asset范围', 'utf8')), bgc=[0.1, 0.6, 0.3],
                         w=175, adjustableColumn=1)
        ...
        # 模型类别
        mc.columnLayout()
        mc.optionMenuGrp('checkAnim2RenderModelType', label=(unicode('检测模型类别', 'utf8')), bgc=[0.1, 0.7, 0.8], w=175,
                         adjustableColumn=1)
        ...
        mc.rowLayout()
        mc.button(w=180, h=50, bgc=[0.3, 0.6, 0.3], label=(unicode('执行检测', 'utf8')),
        ...
        if len(shotInfo) >= 4:
            ...
            if shotInfo[2] in modelHML and shotInfo[3].split('.')[0] in ['rg', 'tx']:
                ...
                if os.path.exists(fileOther):
                    ...
                    anotherVertexNum = []
                    anotherUVsNum = []
                    if mc.ls('CTRL', type='objectSet') and mc.sets('CTRLS', q=1):
                        localAnimObjs = mc.sets('CTRLS', q=1)
                        if localAnimObjs:
                        ...
                        animSetNum.append(0)
                    if mc.ls('MESHES', type='objectSet') and mc.sets('MESHES', q=1):
                        localCacheObjs = mc.sets('MESHES', q=1)
                        if localCacheObjs:
                            localCacheObjs = mc.ls(localCacheObjs, l=1)
                        cacheSetNum.append(len(mc.sets('MESHES', q=1)))
                    # ToothFairies项目无Set，用MODEL判断对比
                    elif shotInfo[0] == 'tf' and (shotInfo[1][0] == 'c' or shotInfo[1][0] == 'p'):
                        localCacheTransforms = mc.listRelatives('MODEL',allDescendents=1,type = 'transform')
                        localCacheMeshs = mc.listRelatives(localCacheTransforms,s=1,ni=1)
                        localCacheObjs = mc.listRelatives(localCacheMeshs,parent=1,type = 'transform')
                        if localCacheObjs:
                            localCacheObjs = mc.ls(localCacheObjs)
                        cacheSetNum.append(len(localCacheObjs))
                    else:
                        cacheSetNum.append(0)
                    ...
                    # ToothFairies项目无Set，用MODEL判断对比
                        ...
                        anotherCacheTransforms = mc.listRelatives('MODEL',allDescendents=1,type = 'transform')
                        anotherCacheMeshs = mc.listRelatives(anotherCacheTransforms,s=1,ni=1)
                        anotherCacheObjs = mc.listRelatives(anotherCacheMeshs,parent=1,type = 'transform')
                        if anotherCacheObjs:
                            anotherCacheObjs = mc.ls(anotherCacheObjs)
                        cacheSetNum.append(len(localCacheObjs))
                    else:
                        cacheSetNum.append(0)
                    # 记录faceNum，vertex，uvs
                    ...
                    if animSetNum[0] != animSetNum[1]:
                        ...
                        checkObjNum = 1
                    if cacheSetNum[0] != cacheSetNum[1]:
                        difInfo = difInfo + (u'cache list数量不同') + '\n'
                        checkObjNum = 1
                    if checkObjNum:
                        print difInfo
                        ...
                        if not difLocalCacheNameInfo and localCacheObjs:
                            for j in range(len(localCacheObjs)):
                                ...
                                if localVertexNum[localID] != anotherVertexNum[anotherID]:
                                    checkVNum = 1
                                if localUVsNum[localID] != anotherUVsNum[anotherID] and shotInfo[0] != 'tf':
                                    checkUNum = 1
    ...
    def checkCacheRigTest(self):
        ...
        if errors == 0:
            ...
            mc.file(save=1, force=1)
            # 获取控制器
            ctrl = mc.ls('Master', type='transform') + mc.ls('Master_ct_an', type='transform') + mc.ls('master',
                                                                                                       type='transform') + mc.ls(
                'master_ct_an', type='transform')
            if ctrl:
                if mc.ls('Master'):
                    ctrl = 'Master'
                    ...
                    if assetFiles:
                        ...
                        for fileName in assetFiles:
                            if fileKeyInfo in fileName:
                                ...
                                # rg文件cache检测
                                # 获取控制器
                                ctrl = mc.ls('Master', type='transform') + mc.ls('Master_ct_an',
                                                                                 type='transform') + mc.ls('master',
                                                                                                           type='transform') + mc.ls(
                                    'master_ct_an', type='transform')
                                if ctrl:
                                    if mc.ls('Master'):
    ...
    def checkCacheDoCreate(self, fileName, objs, path, createType=0, cachePre=0):
        ...
        if createType == 1:
            ...
            # add后的参数为1时自动覆盖
            cacheCMD = 'doCreateGeometryCache 6 { "3", "%s", "%s", "%s", "1", "%s","0","%s","0", "add", "1", "1", "1","0","1","%s","0" }' % (
            str(frameStart + cachePre), str(frameEnd), cacheType, path, fileName, cacheFormat)
            mel.eval(cacheCMD)
            mc.select(cl=1)
    ...
    def checkCacheSetCacheExport(self, objsCache, serverFile=1, cachePre=0, refMode=1, createType=0):
        if objsCache:
            ...
            # 清理目录内文件
            # 只清理txt和cache
            files = mc.getFileList(folder=cachePath, filespec='*.mc') + mc.getFileList(folder=cachePath,
                                                                                       filespec='*.xml') + mc.getFileList(
                folder=cachePath, filespec='*.txt')
            if files:
                for one in files:
                    if one not in ['assetReference.txt', 'shotHideObjs.txt',
                                   'cacheObjVInfo.txt'] and '_anim_' not in one:
    ...
    def checkCacheLocalUpdate(self):
        ...
        for cacheInfo in cacheInfos:
            fileInfo = cacheInfo
            updateCacheCMD = 'zwSysFile "copy" ' + '"' + (localPathCache + fileInfo) + '"' + ' ' + '"' + (
            serverPathCache + fileInfo) + '"' + ' true'
            mel.eval(updateCacheCMD)
            print u'===[Updating Cache To Server]===传输[%s]完毕===' % fileInfo

        # anim上传
        fileInfo = 'ca_animV_objs.txt'
        updateAnimCMD = 'zwSysFile "copy" ' + '"' + (localPathAnim + fileInfo) + '"' + ' ' + '"' + (
        serverPathAnim + fileInfo) + '"' + ' true'
        mel.eval(updateAnimCMD)
    ...
    def checkCacheRecordMaterial(self, checkObjs=[], finalLayout=0, cacheMode=1):
        ...
        if checkObjs:
            ...
            if errorObjs:
                ...
                for obj in checkObjs:
                    mesh = mc.listRelatives(obj, ni=1, type='mesh', s=1)[0]
    ...
    # 还原材质
    def checkCacheReturnMaterial(self, MatLists=[], finalLayout=1):
        if finalLayout:
    ...
    def checkCacheRecordMaterialExport(self, MatLists):
        ...
        shotInfo = sk_infoConfig.sk_infoConfig().checkShotInfo()
        localPath = sk_infoConfig.sk_infoConfig().checkLocalInfoPath()
        localShaderInfoPath = localPath + 'finalLayoutTemp/' + str(shotInfo[0]) + '/' + str(shotInfo[1]) + '/' + str(
            shotInfo[2]) + '/'
        ...
        updateAnimCMD = 'zwSysFile "copy" ' + '"' + (localShaderInfoPath + fileInfo) + '"' + ' ' + '"' + (
        serverDataPath + fileInfo) + '"' + ' true'
        mel.eval(updateAnimCMD)
    ...
    def checkDeleteConnection(self, attr):
        # 被输入方
        if mc.connectionInfo(attr, isDestination=1) and not mc.listAttr(attr, locked=1):
    ...
    def checkFinalLayoutPerform(self, server=1, viewCheck=0, cachePre=-20):
        ...
        if refNodes:
            for i in range(len(refNodes)):
                removePaths = [
                    '//file-cluster/GDC/Projects/ZoomWhiteDolphin/Project/data/ClusterCache/Splash_Base/Splash_Above_I/zm_ef_SplashIn_Above_l_c001.mb']
                removePaths = [
                                  '//file-cluster/GDC/Projects/ZoomWhiteDolphin/Project/data/ClusterCache/Splash_Base/Splash_Above_O/zm_ef_SplashOut_Above_l_c001.mb'] + removePaths
        ...
        # 本地另存
        localFile = localPath + shotInfos[0] + '_' + shotInfos[1] + '_' + shotInfos[2] + '_' + shotInfos[
            3] + '_c001' + fileFormat
        ...
        camServerPath = '//file-cluster/GDC/Projects/' + projectInfo + '/Project/scenes/Animation/episode_' + shotInfos[
            1] + '/episode_camera/'
        ...
        if shotInfos[3] == 'an':
            ...
            if server == 1:
                ...
                fileInfo = '1|' + projectInfo + '|' + newInfo[0] + '_' + newInfo[1] + '_' + newInfo[2] + '_' + newInfo[
                    3] + '_' + newInfo[4] + '|' + userName
    ...
    # 重新输出数据
    def checkFinalLayoutExport(self, grpExport=0, cacheExport=0, animExport=0, assetInfoExport=0, hideInfoExport=0,
                               server=1, cachePre=-50):
    ...
    # 重新载入数据
    def checkFinalLayoutImport(self, grpImport=0, cacheImport=0, animImport=0, assetInfoImport=0, hideInfoImport=0,
                               server=1):
    ...
    def sk_assetInfoUpdate(self, reorganize=[0, 0], needType=1):
        ...
        # 传递
        updateAnimCMD = 'zwSysFile "copy" ' + '"' + (assetLocalPath + txtName) + '"' + ' ' + '"' + (
        assetNeedServerPath + txtName) + '"' + ' true'
        mel.eval(updateAnimCMD)
        print u'\n'
        print(u'=====================【assetInfo】【服务器端】【输出】完毕=====================')
        print u'\n'
            ...
            if info[3].split('.')[0] == 'tx' and 'MODEL' not in rootGrp:
                        ...
                        for i in range(2):
                            ...
                            # 转 cacheModel
                                ...
                                if checkIn == 1:
                                    ...
                                    # checkOut
                                    newInfo = sk_infoConfig.sk_infoConfig().checkShotInfo()
                                    fileInfo = '1|' + projectInfo + '|' + newInfo[0] + '_' + newInfo[1] + '_' + newInfo[
                                        2] + '_' + newInfo[3] + '_' + newInfo[4] + '|' + userName
                                    checkOutCmd = 'idmtService \"Checkout\" \"' + fileInfo + '\"'
                                    # print checkOutCmd
                                    mel.eval(checkOutCmd)
                                    # checkIn
                ...
                # 对set组，判断参考在时进行参考替换
                    ...
                    if checkIn == 1:
                        ...
                        # checkOut
                        newInfo = sk_infoConfig.sk_infoConfig().checkShotInfo()
                        fileInfo = '1|' + projectInfo + '|' + newInfo[0] + '_' + newInfo[1] + '_' + newInfo[2] + '_' + \
                                   newInfo[3] + '_' + newInfo[4] + '|' + userName
                        checkOutCmd = 'idmtService \"Checkout\" \"' + fileInfo + '\"'
                        # print checkOutCmd
                        mel.eval(checkOutCmd)
                        # checkIn
    ...
    def checkTexMo2CacheMo(self, checkin=1):
        ...
        if checkin:
            serverPath = sk_infoConfig.sk_infoConfig().checkProjectServerPath()
            serverSmoothSetInfoPath = serverPath + 'data/AssetInfos/smoothSetInfo/' + shotInfo[0] + '/' + shotInfo[
                1] + '/' + shotInfo[2] + '/'
    ...
    def checkAnimKeyTangentConfig(self):
        ...
        if animCurvs:
            for animC in animCurvs:
                ...
                # 合法切线类型
                types = ["spline", "linear", "fast", "slow", "flat", "step", "stepnext", "fixed", "clamped", "plateau",
                         "auto"]
                # 修正类型
                fiixType = 'auto'
                if inType_animKeys:
    ...
    def checkAnimCurveInfoExport(self, objs, serverFile=1, infoFile='anim', targetPath=''):
        ...
        if objs:
            for obj in objs:
                ...
                # 显示控制点的判断
                if expShapes and mc.objectType(expShapes[0], isType='nurbsCurve') and mc.getAttr(
                                expShapes[0] + '.dispCV'):
                    ...
                    for j in range(pointNum * 2):
                        if mc.objExists(expShapes[0] + '.cv[' + str(j) + ']'):
                            ...
                            if allAttr:
                                for attr in allAttr:
                                    animCurve = mc.listConnections((expShapes[0] + '.' + attr), type='animCurve', s=1,
                                                                   d=0)
                                    if animCurve:
                                        if mc.objExists(animCurve[0]) and 'animCurve' in mc.nodeType(animCurve[0]):
                                        ...
                                        if 'double3' not in mc.getAttr((expShapes[0] + '.' + attr), type=1):
                                            ...
                                            AnimsInfo.append(
                                                'non-anim ' + expShapes[0] + '.' + attr + ' ' + str(value) + ';')
        # fsMode，指定输出地址
        if targetPath == '':
            # 本地输出
            import sk_infoConfig
    ...
    def checkAnimCurveInfoGet(self, animCurve):
        ...
        if time:
            for i in range(len(time)):
                ...
                infoW = (' ' + str(time[i]) + ' ' + str(value[i]) + ' ' + str(inputType[i]) + ' ' + str(
                    outputType[i]) + ' ' + str(weightLock[i]))
                specialFix = ['fixed']
                # 特殊情况补充行
                if inputType[i] in specialFix or outputType[i] in specialFix and weightLock[i]:
                    ...
                    if inputType[i] in specialFix or outputType[i] in specialFix and weightLock[i] != 'True':
                        infoW = infoW + (
                        ' ' + str(inputAngle[i]) + ' ' + str(inputWeight[i]) + ' ' + str(outputAngle[i]) + ' ' + str(
                            outputWeight[i]))
                            ...
                            for j in range(1, linesInfo):
                                ...
                                if (nextLine != '}'):
                                    if (nextLine != '{'):
                                        ...
                                        if infoWeightLock == 'True' and (
                                                infoDetails[3] == 'fixed' or infoDetails[4] == 'fixed'):
                                            # in & out angle
                                            ...
                                            if infoWeightLock != 'True' and (
                                                ...
                                                mc.setKeyframe(key, t=keyFrame, v=keyValue)
                                                mc.selectKey(key, k=keyFrame, r=1)
                                                mc.keyTangent(e=1, ia=keyInputAngle, iw=keyInputWeight,
                                                              oa=keyOutputAngle, ow=keyOutputWeight)
                                            else:
    ...
    def checkShaderColorExport(self):
        ...
        for shader in shaderInfo:
            # 记录名字,color,透明度
            shaderDetails = shader + '|' + str(mc.getAttr(shader + '.colorR')) + '|' + str(
                mc.getAttr(shader + '.colorG')) + '|' + str(mc.getAttr(shader + '.colorB')) + '|' + str(
                mc.getAttr(shader + '.transparencyR')) + '|' + str(mc.getAttr(shader + '.transparencyG')) + '|' + str(
                mc.getAttr(shader + '.transparencyB')) + '|' + str(mc.getAttr(shader + '.diffuse'))
            ...
            if infoNum and infoNum % 2 == 0:
                for i in range(infoNum / 2):
                    ...
                    if shaderDetailsInfo[0] != 'lambert1':
                        ...
                        shader = 'lambert1'
                    mc.setAttr(('%s.color') % (shader), float(shaderDetailsInfo[1]), float(shaderDetailsInfo[2]),
                               float(shaderDetailsInfo[3]), type="double3")
                    mc.setAttr(('%s.transparency') % (shader), float(shaderDetailsInfo[4]), float(shaderDetailsInfo[5]),
                               float(shaderDetailsInfo[6]), type="double3")
                    mc.setAttr(('%s.diffuse') % (shader), float(shaderDetailsInfo[7]))
                    shaderSG = mc.sets(renderable=True, noSurfaceShader=True, empty=True,
                                       name=(shaderDetailsInfo[0] + '_SG'))
    ...
    def checkTexServerPath(self):
        ...
        project = self.checkProjectNameSimple2Full(dirInfo[0])
        serverPathTex = (
        '//file-cluster/GDC/Projects/' + project + '/Project/data/AssetShader/' + str(dirInfo[1]) + '/')
    ...
    def checkTX2AnimRenderLocalPath(self):
        dirInfo = self.checkShotInfo()
        localPathCache = (
        'D:/Info_Temp/temp/tx2AnimRenderTemp/' + dirInfo[0] + '/' + str(dirInfo[1]) + '/' + str(dirInfo[2]) + '/')
    ...
    def checkCacheLocalPath(self):
        ...
        dirInfo = self.checkShotInfo()
        localPathCache = (
        'D:/Info_Temp/temp/geoCacheTemp/' + dirInfo[0] + '/' + str(dirInfo[1]) + '/' + str(dirInfo[2]) + '/')
        mc.sysFile(localPathCache, makeDir=True)
        return localPathCache
    ...
    def checkCacheServerPath(self):
        ...
        project = self.checkProjectNameSimple2Full(dirInfo[0])
        serverPathCache = (
        '//file-cluster/GDC/Projects/' + project + '/Project/data/GeoCache/' + str(dirInfo[1]) + '/' + str(
            dirInfo[2]) + '/')
    ...
    def checkAnimLocalPath(self):
        ...
        localPathAnim = (
        'D:\\Info_Temp\\temp\\animInfoTemp\\' + shotInfo[0] + '\\' + str(shotInfo[1]) + '\\' + str(shotInfo[2]) + '\\')
        mc.sysFile(localPathAnim, makeDir=True)
    ...
    def checkAnimServerPath(self):
        ...
        serverPathAnim = (
        '\\\\file-cluster\\GDC\\Projects\\' + project + '\\Project\\data\\AnimInfo\\' + str(shotInfo[1]) + '\\' + str(
            shotInfo[2]) + '\\')
    ...
    def checkFinalLayoutLocalPath(self):
        ...
        'D:/Info_Temp/temp/finalLayoutTemp/' + dirInfo[0] + '/' + str(dirInfo[1]) + '/' + str(dirInfo[2]) + '/')
    ...
    def checkFinalLayoutServerPath(self):
        ...
        '//file-cluster/GDC/Projects/' + project + '/Project/scenes/Animation/' + 'episode_' + str(
            dirInfo[1]) + '/' + 'scene_' + str(dirInfo[2]) + '/' + 'finishing/')
    ...
    def checkPathInfo(self):
        dirInfo = self.checkShotInfo()
        path = (
        'D:\\Info_Temp\\temp\\cacheTemp\\' + dirInfo[0] + '\\' + str(dirInfo[1]) + '\\' + str(dirInfo[2]) + '\\')
    ...
    '''
         【rig文件生成an文件和render文件，rig文件参考mo文件，如果有tex文件则自动替换参考tex文件，最终生成AN和RNEDER文件都导入参考
         场景tx文件生成AN和RENDER文件】
    Author: 梁宇
    '''

    def GDC_checkRIG(self):
        # 用户名
        import os
        ...
        if info[1][0] not in ['s', 'S']:
            ...
            if rfnNodeLv1:
                for i in range(len(rfnNodeLv1)):
                    pathLower = rfnPathLv1[i].lower()
                    newPath = pathLower.replace('model', 'texture')
                    newPath = newPath.replace('_mo.', '_tx.')
            ...
            # print(unicode('=====================[RigFile Check in] Start=====================', "utf8"))

            # checkIn
            # mel.eval('idmtProject -checkin -description \"Creted By TX File\"')
            # print(unicode('=====================创建【RigFile】完毕=====================', "utf8"))


            # 另存anim
            mc.file(fileName, force=1, options="v=0", type=fileTypeFull, open=1)
            self.GDC_check_saveANorRender('anim')

            print(unicode('=====================[AnimFile Check in] Start=====================', "utf8"))
            # checkOut
            newInfo = sk_infoConfig.sk_infoConfig().checkShotInfo()
            # fileInfo = '1|' + projectInfo + '|' + newInfo[0] + '_' + newInfo[1] + '_' + newInfo[2] + '_' + newInfo[3]+ '_' + newInfo[4]  + '|' + userName
            fn = mc.file(query=True, sceneName=True, shortName=True)
            fileInfo = '1|' + projectInfo + '|' + fn + '|' + userName
            checkOutCmd = 'idmtService \"Checkout\" \"' + fileInfo + '\"'
            print checkOutCmd
            mel.eval(checkOutCmd)
            # checkIn
            ...
            # 另存render
            mc.file(fileName, force=1, options="v=0", type=fileTypeFull  , open=1)
            self.GDC_check_saveANorRender('render')
            print(unicode('=====================[RenderFile Check in] Start=====================', "utf8"))
            # checkOut
            newInfo = sk_infoConfig.sk_infoConfig().checkShotInfo()
            fileInfo = '1|' + projectInfo + '|' + newInfo[0] + '_' + newInfo[1] + '_' + newInfo[2] + '_' + newInfo[3]+ '_' + newInfo[4]  + '|' + userName
            checkOutCmd = 'idmtService \"Checkout\" \"' + fileInfo + '\"'
            ...
            if info[-1].split('.')[0] == 'tx':
                ...
                fileName = mc.file(query=1, exn=1)
                '''
                print(unicode('=====================[TexFile Check in] Start=====================', "utf8"))
           
                # checkIn
                mel.eval('idmtProject -checkin -description \"Creted By TX File\"')
                print(unicode('=====================创建【TexFile】完毕=====================', "utf8"))
                '''
    ...
    '''
        【rig文件导入 参考，生成AN和RENDER文件】
    Author: 梁宇
    '''

    def GDC_check_saveANorRender(self, fileType):
        import sk_infoConfig
        ...
        if fileType == 'anim':             
            ...
            path.append(r'\\file-cluster\GDC\Resource\Support\Maya\projects\DODIII')
            import do3_modelAssignLambert
            reload(do3_modelAssignLambert)           
            do3_modelAssignLambert.do3_modelAssignLambert()
            mel.eval("MLdeleteUnused;")
            self.GDC_ANtxreadData()

                       
        if fileType == 'render':
            fileName = path + info[0] + '_' + info[1] + '_' + info[2] + '_ms_render' + fileFormat      
            #刷新材质球
            self.GDC_renfreshShader()
        ...
        if fileType == 'anim':
            # fileName = path + info[0] + '_' + info[1] + '_' + info[2] + '_ms_anim' + fileFormat
            fn = mc.file(query=True, sceneName=True, shortName=True)
            fn = re.sub(r"(_ms)?_[^_\.]+\.", "_ms_anim.", fn)
            fileName = path + fn
            # 刷新材质球
            self.GDC_renfreshShader()
            print '+++++++++++++++++++++++++++++++++++++++++++++++++++++++'
            ...
            # fileName = path + info[0] + '_' + info[1] + '_' + info[2] + '_ms_render' + fileFormat
            fn = mc.file(query=True, sceneName=True, shortName=True)
            fn = re.sub(r"(_ms)?_[^_\.]+\.", "_ms_render.", fn)
            fileName = path + fn
    ...
    '''
    【把用于动画显示的材质节点信息上传到服务器端】
    Author: 梁宇
    '''

    def GDC_ANtxDataCheck(self):
        import os
        from idmt.maya.commonCore.core_mayaCommon import sk_infoConfig
        ...
        Mn = []
        Nodes = mc.ls('Disp_*', type='lambert')
        for node in Nodes:
            nodeColor = mc.getAttr(node + '.color')[0]
            checkCons = mc.listConnections((node + '.hello'), s=0, d=1, plugs=1)
            if not checkCons:
                continue
            Nod = checkCons[0].split('.')[0]
            if not Nod:
                continue
            tempCons = mc.listConnections((Nod + '.outColor'), s=0, d=1, plugs=1)
            if not tempCons:
                continue
            SGoder = tempCons[0].split('.')[0]
            # 利用d默认=1绕弯子，取了返回transform节点，无语
            # cons= mc.listConnections(SGoder,connections=1, s=1,plugs=0,type='mesh')
            cons = mc.listConnections(SGoder, connections=1, s=1, d=0, plugs=0, type='mesh')
            if not cons:
                continue
            for mesh in cons:
                # if mc.listRelatives(mesh,s=1,f=1) and mc.nodeType(mc.listRelatives(mesh,s=1,f=1)[0])=='mesh':
                Mn.append({mesh: nodeColor})
        ...
        if Mn:
            for data in Mn:
                # data = eval(data)
                if data.values()[0] not in Pn.keys():
                    Pn[data.values()[0]] = []
                Pn[data.values()[0]].append(data.keys()[0])

        ObjsDataServerPath = sk_infoConfig.sk_infoConfig().checkProjectServerPath()
        assetInfo = sk_infoConfig.sk_infoConfig().checkShotInfo()[1]

        servicepath = ObjsDataServerPath + 'data/AssetInfos/' + assetInfo + '/'

        if os.path.exists(servicepath) == 0:
            os.makedirs(servicepath)
        filename = servicepath + assetInfo + '.txt'
    ...
    def GDC_ANtxDataCheckF(self):
        ...
        servicepath = ObjsDataServerPath + 'data/AssetInfos/' + assetInfo + '/'
        temppath='D:/TempInfo/AssetInfos/'+assetInfo + '/'

        if os.path.exists(temppath) == 0:
            mc.sysFile(temppath, makeDir=True)
        txtname=assetInfo + '.txt'
        tempname = temppath+txtname
        sername=servicepath+txtname
        if os.path.exists(tempname):
            mc.sysFile(tempname, delete=True )#
        if Pn:
            txt = open(tempname, 'w')
            try:
                txt.writelines(str(a) + '\r\n' for a in Pn.items())
                ...
                txt.close()
        if os.path.exists(tempname):
            mel.eval('zwSysFile "copy" \"' + tempname + '\" \"' + sername + '\" 1')
        return 0



    '''
         【从服务器端读取数据，赋予An文件颜色材质】
    Author: 梁宇
    '''

    def GDC_ANtxreadData(self):
        from idmt.maya.commonCore.core_mayaCommon import sk_infoConfig
        import os
        ...
        datas = []
        if os.path.exists(filename):
            datas = sk_infoConfig.sk_infoConfig().checkFileRead(filename)
        ...
        if datas:
            for data in datas:
                ...
                shaderNode = mc.shadingNode('lambert', asShader=True, name='DIsplay_for_AN_node')
                mc.setAttr((shaderNode + '.color'), Mcolor[0], Mcolor[1], Mcolor[2], type='double3')

                shaderSG = mc.sets(renderable=True, noSurfaceShader=True, empty=True, name='DIsplay_for_AN_node_SG')
                mc.connectAttr((shaderNode + '.color'), (shaderSG + '.surfaceShader'))
                for obj in Meshes:
                    obj = mc.ls(obj, l=1)
                    try:
    ...
    def GDC_renfreshShader(self, printState=0):
        from idmt.maya.commonCore.core_mayaCommon import sk_referenceConfig
