...
class csl_checkTools(object):
    ...
    '''
    # 前期check工具集
    def csl_sceneUICheckTools(self):
        # 窗口
        if mc.window ("csl_sceneUICheckTools", ex=1):
            mc.deleteUI("csl_sceneUICheckTools", window=True)
        mc.window("csl_sceneUICheckTools", title="Check Tools", widthHeight=(450, 450), menuBar=0)
        # 主界面
        mc.columnLayout()
        
        # 模块
        # from idmt.maya.py_common import csl_checkCommon
        # import csl_checkCommon
        # reload(csl_checkCommon)
        
        # 选取栏
        mc.rowLayout(numberOfColumns=2, columnWidth2=(300, 100))
        mc.textField('csl_sceneUICheckName', w=300 , h=30 , en=1 , text=(unicode('输入整行然后按【提取选择】按钮', 'utf8')))
        mc.button(w=100 , h=30 , bgc=[0, 0.5, 0.8], label=(unicode('【提取选择】', 'utf8')) , c='csl_checkCommon.csl_checkTools().csl_sceneDetailsSelectObject()')
        mc.setParent("..")
        
        # 行按钮
        mc.rowLayout(numberOfColumns=2, columnWidth2=(150, 250))
        # 全自动
        mc.button(w=150 , h=350 , bgc=[0, 0.5, 0.2], label=(unicode('【全自动】【Check】', 'utf8')), c='csl_checkCommon.csl_checkTools().checkModelDetailsWarning()')
        mc.columnLayout()
        # 分割按钮
        # 第1排
        mc.rowLayout(numberOfColumns=2, columnWidth2=(125, 125))
        mc.button(w=125 , h=30 , bgc=[0, 0.4, 0.1], label=(unicode('【Check】【参考】          ', 'utf8')), c='csl_checkCommon.csl_checkTools().checkModelDetailsWarning(\"refCheck\")')
        mc.button(w=125 , h=30 , bgc=[0, 0.4, 0.7], label=(unicode('<<自动更新标记Set>>', 'utf8')),c = 'csl_checkCommon.csl_checkTools().checkCacheSetAdd()\ncsl_checkCommon.csl_checkTools().checkTransAnimSetAdd()\nfrom idmt.maya.py_common import csl_sceneConfig\nreload(csl_sceneConfig)\ncsl_sceneConfig.csl_sceneConfig().csl_sceneCacheAnimSetConfig(\"Cache\",\"ZM\")\ncsl_sceneConfig.csl_sceneConfig().csl_sceneCacheAnimSetConfig(\"Anim\",\"ZM\")')
        mc.setParent("..")
        # 第2排
        mc.rowLayout(numberOfColumns=2, columnWidth2=(125, 125))
        mc.button(w=125 , h=30 , bgc=[0, 0.4, 0.1], label=(unicode('【Check】【namespace】', 'utf8')),c='csl_checkCommon.csl_checkTools().checkModelDetailsWarning(\"nsCheck\")')
        mc.button(w=125 , h=30 , bgc=[0, 0.4, 0.7], label=(unicode('<<namespace工具>>', 'utf8')),c = 'mel.eval(\"common_namespaceTools\")')
        mc.setParent("..")
        # 第3排
        mc.rowLayout(numberOfColumns=2, columnWidth2=(125, 125))
        mc.button(w=125 , h=30 , bgc=[0, 0.4, 0.1], label=(unicode('【Check】【命名】          ', 'utf8')),c='csl_checkCommon.csl_checkTools().checkModelDetailsWarning(\"MSHCheck\")')
        mc.button(w=125 , h=30 , bgc=[0, 0.4, 0.7], label=(unicode('<<选取添加_后缀>>', 'utf8')),c ='csl_checkCommon.csl_checkTools().checkRenameMSHPosfix()')
        mc.setParent("..")
        # 第4排
        mc.rowLayout(numberOfColumns=2, columnWidth2=(125, 125))
        mc.button(w=125 , h=30 , bgc=[0, 0.4, 0.1], label=(unicode('【Check】【面数】          ', 'utf8')),c='csl_checkCommon.csl_checkTools().checkModelDetailsWarning(\"faceCheck\")')
        mc.button(w=125 , h=30 , bgc=[0, 0.4, 0.7], label=(unicode('<<自动处理重命名>>', 'utf8')),c ='csl_checkCommon.csl_checkTools().checkSameRename()\ncsl_checkCommon.csl_checkTools().checkSameRename(\"mesh\")\ncsl_checkCommon.csl_checkTools().checkSameRename(\"nurbsCurve\")\ncsl_checkCommon.csl_checkTools().checkMSHKeepOneRename(\"MSH\")')
        mc.setParent("..")
        # 第5排
        mc.rowLayout(numberOfColumns=2, columnWidth2=(125, 125))
        mc.button(w=125 , h=30 , bgc=[0, 0.4, 0.1], label=(unicode('【Check】【instance】    ', 'utf8')),c='csl_checkCommon.csl_checkTools().checkModelDetailsWarning(\"insCheck\")')
        mc.button(w=125 , h=30 , bgc=[0, 0.4, 0.7], label=(unicode('<<displaceLayer清理>>', 'utf8')),c = 'csl_checkCommon.csl_checkTools().checkCleanDisplayLayers()')
        mc.setParent("..")
        # 第6排
        mc.rowLayout(numberOfColumns=2, columnWidth2=(125, 125))
        mc.button(w=125 , h=30 , bgc=[0, 0.4, 0.1], label=(unicode('【Check】【smooth】     ', 'utf8')),c='csl_checkCommon.csl_checkTools().checkModelDetailsWarning(\"smoothCheck\")')
        mc.button(w=125 , h=30 , bgc=[0, 0.4, 0.7], label=(unicode('<<renderLayer清理>>', 'utf8')), c = 'csl_checkCommon.csl_checkTools().checkCleanRenderLayers()')
        mc.setParent("..")        
        # 第7排
        mc.rowLayout(numberOfColumns=2, columnWidth2=(125, 125))
        mc.button(w=125 , h=30 , bgc=[0, 0.4, 0.1], label=(unicode('【Check】【标记】         ', 'utf8')),c='csl_checkCommon.csl_checkTools().checkModelDetailsWarning(\"signCheck\")')
        mc.button(w=125 , h=30 , bgc=[0, 0.4, 0.7], label=(unicode('<<自动清理空组>>', 'utf8')),c = 'mel.eval(\"deleteEmptyGroups()\")')
        mc.setParent("..")
        # 第8排
        mc.rowLayout(numberOfColumns=2, columnWidth2=(125, 125))
        mc.button(w=125 , h=30 , bgc=[0, 0.4, 0.1], label=(unicode('【Check】【物体重名】  ', 'utf8')),c='csl_checkCommon.csl_checkTools().checkModelDetailsWarning(\"sameTransformCheck\")')
        mc.button(w=125 , h=30 , bgc=[0, 0.4, 0.7], label=(unicode('<<显示|隐藏骨骼>>', 'utf8')),c = 'csl_checkCommon.csl_checkTools().checkJointViewHide()')
        mc.setParent("..")      
        
        # 第9排
        mc.rowLayout(numberOfColumns=2, columnWidth2=(125, 125))
        mc.button(w=125 , h=30 , bgc=[0, 0.4, 0.1], label=(unicode('【Check】【shape重名】', 'utf8')),c='csl_checkCommon.csl_checkTools().checkModelDetailsWarning(\"sameShapeCheck\")')
        mc.button(w=125 , h=30 , bgc=[0.1, 0.1, 0.1], label=(unicode('<<添加|ct_an标记>>', 'utf8')), c ='csl_checkCommon.csl_checkTools().checkCTANSignAdd()')
        mc.setParent("..")        
        
        # 第10排
        mc.rowLayout(numberOfColumns=2, columnWidth2=(125, 125))
        mc.button(w=125 , h=30 , bgc=[0, 0.4, 0.1], label=(unicode('【Check】【Mesh同名】', 'utf8')),c='csl_checkCommon.csl_checkTools().checkModelDetailsWarning(\"sameShapeNodeCheck\")')
        mc.button(w=125 , h=30 , bgc=[0, 0.4, 0.1], label=(unicode('【Check】【proxy位移】', 'utf8')),c='csl_checkCommon.csl_checkTools().checkModelDetailsWarning(\"proxyInfo\")')
        mc.setParent("..")   
        
        # 第11排
        mc.rowLayout(numberOfColumns=2, columnWidth2=(125, 125))
        mc.button(w=125 , h=30 , bgc=[0, 0.4, 0.1], label=(unicode('【Check】【smoothSet】', 'utf8')),c='csl_checkCommon.csl_checkTools().checkModelDetailsWarning(\"smoothSet\")')
        mc.button(w=125 , h=30 , bgc=[0, 0.4, 0.1], label=(unicode('【Check】【renderState】', 'utf8')),c='csl_checkCommon.csl_checkTools().checkModelDetailsWarning(\"renderState\")')
        mc.setParent("..")     
        ...
        # mc.rowLayout()
        # 单独导入音轨
        # mc.button(w = 150 , h = 30 ,bgc = [0,0.7,0.2],label = (unicode('【动画】只导入音频', 'utf8')) , c = 'csl_sceneConfig.csl_sceneConfig().csl_sceneImportAudio()' )
        # mc.setParent("..")
        
        
        mc.setParent("..")
        mc.showWindow("csl_sceneUICheckTools")
        
    # 提取选择物体
    def csl_sceneDetailsSelectObject(self):
        pathInfo = mc.textField('csl_sceneUICheckName', q=1, text=1)
    ...
    '''
    # 重新排序
    def csl_checkObjOutlinerReorder(self,objList):
        # 记录长度
        lenInfoList = []
        for obj in objList:
    ...
    def checkMSHName(self, model):
        ...
        if grps:
            for grp in grps:
                ...
                if grpConfig[-1] == '_' and shotInfo[0] in ['csl']:
                    num=''
                    split = grpConfig.split('_')
                    if split[0][0]=='p':
                        num=split[0][1:7]                    
                    if split[0][0]=='p' and type(num)==int and int(num)>=1000 and len(split) < 4:
                        errorInfo.append(grp)
                # mesh'_'后缀判断
                if grpConfig[-1] == '_' :
                    split = grpConfig.split('_')
                    ...
                    shape = mc.listRelatives(grp , pa=1 , ni=1 , s=1  , f=1)
                    if mc.nodeType(shape[0]) in ['mesh','aiStandIn']:
                        continue
                    else:
                        errorInfo.append(grp)
                # 无'_'后缀的判断，除了nurbsCurve，必须没有Shape
                    ...
                    if shape:
                        ...
                        if split[0][0]=='p':
                            num=split[0][1:7]                    
                        if shotInfo[1][0]=='p' and split[0][0]=='p' and num!='' and int(num)>=1000 and mc.nodeType(shape[0]) not in needNodes:
                            errorInfo.append(grp)
        ...
        if smoothSetCheck == 0:
            ...
            if smoothObjs:
                ...
                for obj in smoothObjs:
                    if '_si_' not in obj and  '_nr_' not in obj and '_proxy_' not in obj and '_p_' not in obj:
            ...
            if objs:
                for obj in objs:
                    if mc.listRelatives(obj,c=1,ni=1,type = 'mesh',f=1):
                        ...
                        #attrs = ['.receiveShadows','.motionBlur','.primaryVisibility','.smoothShading']
                        checkState = 0
                        for attr in attrs:
...
#                errorNames = csl_sceneConfig.csl_sceneConfig().csl_sceneProxyInfoCheck(0)
#                if errorNames:
#                    for name in errorNames:
...
#                import csl_smoothSet
#                reload(csl_smoothSet)
...
#        reload(csl_infoConfig)
    ...
    '''
    # 选取非MODEL组的
    def csl_sceneSelectAllPolygon(self):
        grps = mc.ls(type = 'transform',l=1)
        objs = []
        for grp in grps:
            if '|MODEL' not in grp:
...
#        reload(csl_infoConfig)
    ...
    def checkAnim2RenderSetUI(self):
        # 窗口
        if mc.window ("csl_checkAnim2RenderSetUI", ex=1):
            mc.deleteUI("csl_checkAnim2RenderSetUI", window=True)
        mc.window("csl_checkAnim2RenderSetUI", title="Check Anim Render Cache List", widthHeight=(175, 100), menuBar=0)
        # 主界面
        mc.columnLayout()
        ...
        mc.columnLayout()
        mc.optionMenuGrp('csl_checkAnim2RenderCheckType', label=(unicode('检测Asset范围', 'utf8')), bgc=[0.1, 0.6, 0.3], w=175, adjustableColumn=1)
        ...
        mc.optionMenuGrp('csl_checkAnim2RenderCheckType' ,e = 1 ,select = 5 )
        mc.optionMenuGrp('checkAnim2RenderModelType' ,e = 1 ,select = 3 )
        
        mc.rowLayout()
        mc.button(w=180 , h=50 , bgc=[0.3, 0.6, 0.3], label=(unicode('执行检测', 'utf8')), c='import maya.cmds as mc\ncheckType = mc.optionMenuGrp(\"csl_checkAnim2RenderCheckType\",q=1, value=1)[1]\nmodelType = mc.optionMenuGrp(\"checkAnim2RenderModelType\",q=1, value=1)[1]\ncsl_checkCommon.csl_checkTools().checkAnim2RenderSetInfo(checkType,modelType)')
        mc.setParent("..")

        mc.setParent("..")
        mc.setParent("..")   
        mc.showWindow("csl_checkAnim2RenderSetUI")
    ...
    def checkAssetAnim2RenderCore(self,assetName,assetType,checkType,modelType):
        ...
        nofileInfo = ''
        # 准备工作
        shotInfo = csl_infoConfig.csl_infoConfig().checkShotInfo()
        projectName = csl_infoConfig.csl_infoConfig().checkProjectNameSimple2Full(shotInfo[0])
        mayaType = csl_infoConfig.csl_infoConfig().checkProjectFileFormat(shotInfo[0])
...
#        reload(csl_infoConfig)
        ...
        if len(shotInfo) >= 4: 
            ...
            if assetName in assetInfo[2] or shotInfo[1][0] == 'p':
                assetType = 'props'
            if assetName in assetInfo[3] or shotInfo[1][0] in ['s', 'S']:
                assetType = 'sets'
            modelHML = ['l','m','h']
            print u'---------------'
...
#            import csl_infoConfig
    ...
    def checkDonotNodeClean(self, unuse=1 , turtle=1 , arnold = 0):
        ...
        refExist = ''
        try:
            refExist = mc.referenceQuery('//file-cluster/GDC/Resource/Support/Maya/extra/Rigging_Simulation/python/edo/general/Qcsl_lib/Qcsl_model.ma',rfn=1)
        except:
            pass
        if refExist:
...
#        reload(csl_infoConfig)
    ...
    '''
    # 为方便修改更新，所有cacheSet物体全部创建cache
    def csl_checkBakeConstraints(self):
...
#        import csl_infoConfig
    ...
    def checkFinalLayoutPerform(self , server = 1 , viewCheck = 0 , cachePre = -50 ):
        ...
        import csl_infoConfig
        reload(csl_infoConfig)
        import csl_hbExceptCam
        reload(csl_hbExceptCam)
        import csl_referenceConfig
        reload(csl_referenceConfig)
        import os

        # 处理非参考的namespace
        csl_sceneConfig.csl_sceneConfig().csl_sceneNoRefNamespaceClean()
        print u'\n====================多层namespace清理完毕====================\n'

        # 检测参考是否正确，是否有render参考
        refInfos = csl_referenceConfig.csl_referenceConfig().checkReferenceListInfo()
        ...
        # 记录项目，场次，镜头号,文件类型
        shotInfos = csl_infoConfig.csl_infoConfig().checkShotInfo()
        fileFormat = csl_infoConfig.csl_infoConfig().checkProjectFileFormat(shotInfos[0])
        print u'\n'
        print(u'=====================【%s_%s】【FinalLayout】开始处理！！！====================='%(shotInfos[1],shotInfos[2]))
        print(u'=========================================================================')

        # 修正时间轴
        csl_sceneConfig.csl_sceneConfig().csl_sceneImportFrame('frame')
        
        # 获取finalLayout临时路径
        localPath = csl_infoConfig.csl_infoConfig().checkFinalLayoutLocalPath()
        # 获取finalLayout服务器端路径
        serverPath = csl_infoConfig.csl_infoConfig().checkFinalLayoutServerPath()
        ...
        csl_sceneConfig.csl_sceneConfig().csl_sceneUnloadRefDel(1,0)
        print u'\n'
        print u'========================未勾选参考清理完毕========================'
        print u'\n'
        ...
        # 更新摄像机
        projectInfo = csl_infoConfig.csl_infoConfig().checkProjectNameSimple2Full(shotInfos[0])
        ...
        if os.path.exists(camServerPath):
            ...
            if server:
                csl_sceneConfig.csl_sceneConfig().csl_sceneCameraUpdate(1)
                print u'\n'
                print u'==========================camera传输完毕=========================='
                print u'\n'
        ...
        # 清理服务器端旧的SET和OTC文件
        csl_sceneConfig.csl_sceneConfig().csl_sceneGRPDelete('SET')
        csl_sceneConfig.csl_sceneConfig().csl_sceneGRPDelete('OTC')

        # 处理SET_GRP和OTC_GRP内的参考
        # 处理大组
        csl_sceneConfig.csl_sceneConfig().csl_sceneReorganize(0)
        print u'\n'
        print u'==========================文件整理完毕=========================='
        print u'\n'
        ...
        if server:
            ...
            hideObjsServerPath = csl_infoConfig.csl_infoConfig().checkCacheServerPath()
            ...
            for i in range(len(rfnLv1)):
                ...
                if noNeedRefNodeInfo:
                    ...
                    if refNode.split('_')[1][0] not in ['s', 'S']:
                        ...
                        assetNeedOutputInfo.append(newPath)
                        assetNeedOutputInfo.append(ns)
            assetNeedServerPath = csl_infoConfig.csl_infoConfig().checkCacheServerPath()
        ...
        # 诡异，这个居然会影响到新建文件的参考
        #csl_referenceConfig.csl_referenceConfig().checkReferenceShaderReset(1)
        
        # 导出SET_GRP和OTC_GRP文件
        csl_sceneConfig.csl_sceneConfig().csl_sceneGRPExport('SET')
        csl_sceneConfig.csl_sceneConfig().csl_sceneGRPExport('OTC')
        print u'\n'
        ...
        if shotInfos[3] == 'an':
            ...
            csl_sceneConfig.csl_sceneConfig().csl_sceneSETRefShaderReset([shotInfos[0],shotInfos[1],shotInfos[2]])
            ...
            # 导回SET_GRP和OTC_GRP
            csl_sceneConfig.csl_sceneConfig().csl_sceneGRPImport('SET')
            csl_sceneConfig.csl_sceneConfig().csl_sceneGRPImport('OTC')
            print u'\n'
            ...
            # 导入cam
            # 导入相机
            csl_hbExceptCam.csl_hbExceptCam().camServerReference()
    
            # 处理大组
            csl_sceneConfig.csl_sceneConfig().csl_sceneReorganize(1)
            ...
            # 本地保存
            fileTypeFull = csl_infoConfig.csl_infoConfig().checkProjectFileFormatFull(shotInfos[0])
            ...
            if viewCheck:
                # 加载所有参考
                csl_sceneConfig.csl_sceneConfig().csl_sceneUnloadRefDel(0,1)
                import csl_camMatrixScene
                reload(csl_camMatrixScene)
                print '\n'
                ...
                if mc.ls(camName):
                    csl_camMatrixScene.csl_camMatrixScene().csl_sceneMeshCamConfig( startFrame, endFrame ,camName,[],8)
                else:
                    pass
            ...
            if server == 1:
                ...
                newInfo = csl_infoConfig.csl_infoConfig().checkShotInfo()
                projectInfo = csl_infoConfig.csl_infoConfig().checkProjectNameSimple2Full(newInfo[0])
    ...
    # 处理FINALLAYOUT文件
    def csl_sceneFLRefShaderReset(self , info ):
        import csl_infoConfig
        reload(csl_infoConfig)
        import csl_referenceConfig
        reload(csl_referenceConfig)
        # 处理OTC的SET文件，但不载入参考
        fileFomat = csl_infoConfig.csl_infoConfig().checkProjectFileFormat(info[0])
        fileGrpType = '_base_fs_c001'

        needFilePath = csl_infoConfig.csl_infoConfig().checkFinalLayoutLocalPath() 
    ...
    def checkFinalLayoutExport(self, grpExport = 0 , cacheExport = 0 , animExport = 0 , assetInfoExport = 0 , hideInfoExport = 0 ,server = 1 , cachePre = -50):
        if grpExport or cacheExport or animExport or assetInfoExport or hideInfoExport:
            ...
            # 处理大组
            csl_sceneConfig.csl_sceneConfig().csl_sceneReorganize(server)
    ...
    def checkFinalLayoutImport(self, grpImport = 0 , cacheImport = 0 , animImport = 0 , assetInfoImport = 0 ,  hideInfoImport= 0 ,server = 1):
        if grpImport or cacheImport or animImport or assetInfoImport or hideInfoImport:
            ...
            # 首先处理好时间轴
            # FPS
            csl_sceneConfig.csl_sceneConfig().csl_sceneImportFrame('FPS')
            # frame
            csl_sceneConfig.csl_sceneConfig().csl_sceneImportFrame('frame')
            ...
            if cacheImport:
                ...
                if cacheObjs:
                    #self.checkCacheSetCacheImport(cacheObjs, server)
                    self.csl_flCacheImportRefreshShaders(server)
                    # 导入显示隐藏信息
                    self.checkCacheVStateImport()
                    #print(unicode('=====================【Cache】【服务器端】【导入】完毕=====================', "utf8"))
                    print(u'=====================【Cache】【服务器端】【导入】完毕=====================')
    ...
    def csl_assetInfoUpdate(self,reorganize = [0,0],needType = 1):
        import csl_sceneConfig
        reload(csl_sceneConfig)
        import csl_referenceConfig
        reload(csl_referenceConfig)
        ...
        if needType == 1:
            ...
            # 处理大组
            if reorganize[0]:
                csl_sceneConfig.csl_sceneConfig().csl_sceneReorganize(reorganize[1])
        ...
        assetLocalPath = csl_infoConfig.csl_infoConfig().checkCacheLocalPath()
        assetNeedServerPath = csl_infoConfig.csl_infoConfig().checkCacheServerPath()
    ...
    # fl文件处理cache并保持更新材质
    def csl_flCacheImportRefreshShaders(self,server):
        import csl_referenceConfig
        reload(csl_referenceConfig)
        import csl_sceneConfig
        reload(csl_sceneConfig)
    ...
    # 非anim转anim
    def csl_zmNotAnim2Anim(self):
        import csl_referenceConfig
        reload(csl_referenceConfig)
        refInfo = csl_referenceConfig.csl_referenceConfig().checkReferenceListInfo()
    ...
    def checkTexTransformtMo(self, checkIn=0, backTx=1):
        ...
        import csl_infoConfig
        reload(csl_infoConfig)
        info = csl_infoConfig.csl_infoConfig().checkShotInfo()
        projectInfo = csl_infoConfig.csl_infoConfig().checkProjectNameSimple2Full(info[0])
        # 改成复制到本地
        # 是否本地文件判断
        ...
        if errors == 0:
            ...
            fileTypeFull = csl_infoConfig.csl_infoConfig().checkProjectFileFormatFull(info[0])
            fileName = mc.file(query=1, exn=1)
            # rootGrp检测
    ...
    def checkCaheObjRenderState(self):
        ...
        if cacheObjs:
            for obj in cacheObjs:
                shape = mc.listRelatives(obj ,c= 1,type ='mesh')
                if shape:
    ...
    def checkTexNoAC2AnimMo(self, fileType):
        ...
        path = csl_infoConfig.csl_infoConfig().checkPCFilePath()
        info = csl_infoConfig.csl_infoConfig().checkShotInfo()
        fileFormat = csl_infoConfig.csl_infoConfig().checkProjectFileFormat(info[0])
        if fileType == 'anim':
        ...
        if joints:
            for joint in joints:
                if mc.getAttr(joint + '.overrideEnabled',l=1):
                    pass
                else:
                    mc.setAttr((joint + '.overrideEnabled'), 1)
                if mc.getAttr(joint +'.overrideLevelOfDetail',l=1):
                    pass
                else:
                    mc.setAttr((joint + '.overrideLevelOfDetail'), 1)
...
#        reload(csl_smoothSet)
        ...
        path = csl_infoConfig.csl_infoConfig().checkPCFilePath()
        shotInfo = csl_infoConfig.csl_infoConfig().checkShotInfo()
        fileFomat = csl_infoConfig.csl_infoConfig().checkProjectFileFormat(shotInfo[0])
        fileName = path + shotInfo[0] + '_' + shotInfo[1] + '_' + shotInfo[2] + '_ms_render' + fileFomat
        mc.select(rootGrp)
        fileTypeFull = csl_infoConfig.csl_infoConfig().checkProjectFileFormatFull(shotInfo[0])
        ...
        # 重建smoothSet
        if checkin:
            serverPath = csl_infoConfig.csl_infoConfig().checkProjectServerPath()
    ...
    def checkTexMo2AnimMo(self):
        ...
        #import csl_sceneConfig
        #reload(csl_sceneConfig)
        #csl_sceneConfig.csl_sceneConfig().csl_sceneProxySetAdd()
        #csl_sceneConfig.csl_sceneConfig().csl_sceneProxySetObjects()
        #csl_sceneConfig.csl_sceneConfig().csl_sceneMasterDelete()
    ...
    def checkAnimCurveInfoExport(self, objs, serverFile=1, infoFile='anim' , targetPath = ''):
        ...
        if targetPath == '':
            ...
            reload(csl_infoConfig)
            # shotInfo = csl_infoConfig.csl_infoConfig().checkShotInfo()
            localPathAnim = csl_infoConfig.csl_infoConfig().checkAnimLocalPath()
    ...
    def checkAnimInfoUpdate(self, infoFile):
        ...
        reload(csl_infoConfig)
        # 本地路径转mel用
        localPathAnim = csl_infoConfig.csl_infoConfig().checkAnimLocalPath().replace('\\', '/')
        # 服务器端路径转mel用
        serverPathAnim = csl_infoConfig.csl_infoConfig().checkAnimServerPath().replace('\\', '/')
        # 开始上传
    ...
    def checkAnimCurveInfoImport(self, serverFile=1, infoFile='anim' , replace = [] ,targetPath = ''):
        ...
        if targetPath == '':
            # 本地获取
            if serverFile == 1:
                serverPathAnim = csl_infoConfig.csl_infoConfig().checkAnimServerPath()
    ...
    def checkShaderColorExport(self):
        ...
        import csl_infoConfig
        reload(csl_infoConfig)
        localPath = csl_infoConfig.csl_infoConfig().checkTexLocalPath() + 'shader.txt'
        serverPath = csl_infoConfig.csl_infoConfig().checkTexServerPath() + 'shader.txt'
    ...
    def checkJointViewHide(self):
        # 隐藏骨骼
        joints = mc.ls(type='joint')
        if mc.getAttr(joints[0] + '.overrideLevelOfDetail') == 1:
            showType = 0
        if mc.getAttr(joints[0] + '.overrideLevelOfDetail') == 0:
            showType = 1
        for joint in joints:
            if mc.getAttr(joint + '.overrideEnabled',l=1):
                pass
            ...
            if mc.getAttr(joint +'.overrideLevelOfDetail',l=1):
                ...
                mc.setAttr((joint + '.overrideLevelOfDetail'), showType)
    ...
    Data    :2015_01_24
    '''
    def checkLightCP(self):
        shotInfo = sk_infoConfig.sk_infoConfig().checkShotInfo()
        if len(shotInfo)>2 and shotInfo[1][0] in ['c','p']:
            light=mc.ls(lt=1,l=1)+mc.ls(type='aiSkyDomeLight',l=1)
            if mc.ls(light):
                mc.select(light)
                mc.error(u'文件中有非法灯光，请修改文件')
        print u'\n\n 灯光检测OK'                   
        return 0
