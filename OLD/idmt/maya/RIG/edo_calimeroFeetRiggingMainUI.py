...
def edo_calimeroFeetRiggingMainUI():
    ...
    cmds.button('calimeroFeetRiggingMainUI_CL01_BT03',l='add debug rig[only used to the old rig]',w=300,h=40,c='edo_CalimeroFeetRiggingDebug()')
...
def edo_CalimeroFeetRiggingDebug():
    cmds.connectAttr('LfLeg_Leg_IK.swivelToe','Lf_ball_toe_con_Grp.ry',f=1)
    cmds.connectAttr('RtLeg_Leg_IK.swivelToe','Rt_ball_toe_con_Grp.ry',f=1)
    cmds.connectAttr('LfLeg_Leg_IK.raiseToe','Lf_ball_toe_con_Grp.rz',f=1)
    cmds.connectAttr('RtLeg_Leg_IK.raiseToe','Rt_ball_toe_con_Grp.rz',f=1)
    cmds.renameAttr( 'LfLeg_Leg_IK.Open_Toe', 'connect_Open_Toe' )
    cmds.renameAttr( 'RtLeg_Leg_IK.Open_Toe', 'connect_Open_Toe' )
    cmds.addAttr('LfLeg_Leg_IK',ln='Open_Toe',at='double')
    cmds.addAttr('RtLeg_Leg_IK',ln='Open_Toe',at='double')
    cmds.addAttr('LfLeg_Leg_IK',ln='RaiseToe',at='double')
    cmds.addAttr('LfLeg_Leg_IK',ln='SwivelToe',at='double')
    cmds.addAttr('RtLeg_Leg_IK',ln='RaiseToe',at='double')
    cmds.addAttr('RtLeg_Leg_IK',ln='SwivelToe',at='double')
    cmds.addAttr('LfLeg_Ankle_FK',ln='Open_Toe',at='double')
    cmds.addAttr('LfLeg_Ankle_FK',ln='RaiseToe',at='double')
    cmds.addAttr('LfLeg_Ankle_FK',ln='SwivelToe',at='double')
    cmds.addAttr('RtLeg_Ankle_FK',ln='Open_Toe',at='double')
    cmds.addAttr('RtLeg_Ankle_FK',ln='RaiseToe',at='double')
    cmds.addAttr('RtLeg_Ankle_FK',ln='SwivelToe',at='double')
    cmds.setAttr('LfLeg_Leg_IK.Open_Toe',e=1,k=1)
    cmds.setAttr('RtLeg_Leg_IK.Open_Toe',e=1,k=1)
    cmds.setAttr('LfLeg_Ankle_FK.Open_Toe',e=1,k=1)
    cmds.setAttr('RtLeg_Ankle_FK.Open_Toe',e=1,k=1)
    cmds.setAttr('LfLeg_Ankle_FK.RaiseToe',e=1,k=1)
    cmds.setAttr('LfLeg_Ankle_FK.SwivelToe',e=1,k=1)
    cmds.setAttr('RtLeg_Ankle_FK.RaiseToe',e=1,k=1)
    cmds.setAttr('RtLeg_Ankle_FK.SwivelToe',e=1,k=1)
    cmds.setAttr('LfLeg_Leg_IK.RaiseToe',e=1,k=1)
    cmds.setAttr('RtLeg_Leg_IK.RaiseToe',e=1,k=1)
    cmds.setAttr('LfLeg_Leg_IK.SwivelToe',e=1,k=1)
    cmds.setAttr('RtLeg_Leg_IK.SwivelToe',e=1,k=1)
    cmds.addAttr('LfLeg_Leg_IK',ln='connect_RaiseToe',at='double')
    cmds.addAttr('LfLeg_Leg_IK',ln='connect_SwivelToe',at='double')
    cmds.addAttr('RtLeg_Leg_IK',ln='connect_RaiseToe',at='double')
    cmds.addAttr('RtLeg_Leg_IK',ln='connect_SwivelToe',at='double')
    cmds.setAttr('LfLeg_Leg_IK.connect_RaiseToe',e=1,k=1)
    cmds.setAttr('RtLeg_Leg_IK.connect_RaiseToe',e=1,k=1)
    cmds.setAttr('LfLeg_Leg_IK.connect_SwivelToe',e=1,k=1)
    cmds.setAttr('RtLeg_Leg_IK.connect_SwivelToe',e=1,k=1)
    cmds.renameAttr('LfLeg_Leg_IK.raiseToe','original_raistToe')
    cmds.renameAttr('RtLeg_Leg_IK.raiseToe','original_raistToe')
    cmds.renameAttr('LfLeg_Leg_IK.swivelToe','original_swivelToe')
    cmds.renameAttr('RtLeg_Leg_IK.swivelToe','original_swivelToe')
    edo_replaceDriverAttr('LfLeg_Leg_IK.original_raistToe','LfLeg_Leg_IK.connect_RaiseToe')
    edo_replaceDriverAttr('RtLeg_Leg_IK.original_raistToe','RtLeg_Leg_IK.connect_RaiseToe')
    edo_replaceDriverAttr('LfLeg_Leg_IK.original_swivelToe','LfLeg_Leg_IK.connect_SwivelToe')
    edo_replaceDriverAttr('RtLeg_Leg_IK.original_swivelToe','RtLeg_Leg_IK.connect_SwivelToe')
    edo_addIKFKblendConnections('LfLeg_Leg_IK.Open_Toe','LfLeg_Ankle_FK.Open_Toe','LfLeg_Leg_IK.connect_Open_Toe','LfLeg_Switch.IKFK')
    edo_addIKFKblendConnections('LfLeg_Leg_IK.RaiseToe','LfLeg_Ankle_FK.RaiseToe','LfLeg_Leg_IK.connect_RaiseToe','LfLeg_Switch.IKFK')
    edo_addIKFKblendConnections('LfLeg_Leg_IK.SwivelToe','LfLeg_Ankle_FK.SwivelToe','LfLeg_Leg_IK.connect_SwivelToe','LfLeg_Switch.IKFK')
    edo_addIKFKblendConnections('RtLeg_Leg_IK.Open_Toe','RtLeg_Ankle_FK.Open_Toe','RtLeg_Leg_IK.connect_Open_Toe','RtLeg_Switch.IKFK')
    edo_addIKFKblendConnections('RtLeg_Leg_IK.RaiseToe','RtLeg_Ankle_FK.RaiseToe','RtLeg_Leg_IK.connect_RaiseToe','RtLeg_Switch.IKFK')
    edo_addIKFKblendConnections('RtLeg_Leg_IK.SwivelToe','RtLeg_Ankle_FK.SwivelToe','RtLeg_Leg_IK.connect_SwivelToe','RtLeg_Switch.IKFK')
    
def edo_addIKFKblendConnections(ikattr,fkattr,drivenAttr,switchattr):
    #ikattr='LfLeg_Leg_IK.Open_Toe'
    #fkattr='LfLeg_Ankle_FK.Open_Toe'
    #drivenAttr='LfLeg_Leg_IK.connect_Open_Toe'
    #switchattr='LfLeg_Switch.IKFK'
    bn=cmds.createNode('blendTwoAttr')
    #iv=cmds.createNode('reverse')
    #cmds.connectAttr(switchattr,iv+'.inputX',f=1)
    cmds.connectAttr(ikattr,bn+'.input[1]',f=1)
    cmds.connectAttr(fkattr,bn+'.input[0]',f=1)
    cmds.connectAttr(switchattr,bn+'.attributesBlender',f=1)
    cmds.connectAttr(bn+'.output',drivenAttr,f=1)
    #cmds.setAttr(drivenAttr,e=1,k=0)
    #cmds.setAttr(drivenAttr,e=1,l=1)
    
    
    
def edo_replaceDriverAttr(sc,dir):
    #sc='LfLeg_Leg_IK.original_raistToe'
    #dir='LfLeg_Leg_IK.RaiseToe'
    allanims=cmds.listConnections(sc,s=0,d=1,t='animCurve')
    if not allanims==None and not allanims==[]:
        for anim in allanims:
            #anim=allanims[0]
            cmds.connectAttr(dir,anim+'.input',f=1)
