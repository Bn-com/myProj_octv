...
class RiggingTools():
    ...
    def runLayout(self):
        ...
        rig.button(label = u' 【plugin】弧形运动目标体 ' ,w = 312 ,c ='execfile(\'Z:/Resource/Groups/Production/Modeling/Rigging 2009 Development Plan/BodyRiggingTools/script/RIG/tools/zvradialblendshape100Initialize.py\')')
