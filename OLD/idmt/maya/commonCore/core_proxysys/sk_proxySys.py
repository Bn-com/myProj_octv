...
class sk_proxySys(object):
    ...
    def sk_sceneUICameraTools(self):
        from idmt.maya.core_common.core_mayaCommon import sk_infoConfig
        ...
        mc.button(w=150 , h=30 , bgc=[0, 1, 0.2], label=(unicode('【动画】导入音频及相机', 'utf8')) , c='from idmt.maya.core_common.core_mayaCommon import sk_sceneTools\nreload(sk_sceneTools)\nsk_sceneTools.sk_sceneTools().sk_sceneImportCameraAudioFrame()')
        mc.setParent("..")

        mc.rowLayout()
        mc.button(w=150 , h=30 , bgc=[0.6, 0.2, 0.2], label=(unicode('【动画】导出最终相机', 'utf8')), c='from idmt.maya.core_common.core_mayaCommon import sk_sceneTools\nreload(sk_sceneTools)\nsk_sceneTools.sk_sceneTools().sk_sceneCameraUpdate()')
        mc.setParent("..")
    ...
    def sk_sceneCameraUpdate(self,batchUpadate = 0):
        from idmt.maya.core_common.core_mayaCommon import sk_infoConfig
        reload(sk_infoConfig)
        from idmt.maya.core_common.core_mayaCommon import sk_referenceConfig
        reload(sk_referenceConfig)
        from idmt.maya.core_common.core_mayaCommon import sk_checkCommon
        ...
        # 相机Export
        from idmt.maya.core_common.core_mayaCommon import sk_hbExportCam
    ...
    def sk_sceneSetCombineConfig(self,proType):
        from idmt.maya.core_common.core_mayaCommon import sk_smoothSet
        reload(sk_smoothSet)
