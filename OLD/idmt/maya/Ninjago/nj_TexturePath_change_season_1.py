    ...
    for j in needIndexs:
        for k in range(j,j+10):
            ...
            if 'file' in readInfos[k]:
                newLineInfo = readInfos[k].replace('Z:/Projects/Ninjago/Ninjago_scratch/lighting&compositing/masterlighting','Z:/Resource/Library/Reference/MasterLighting/Ninjago/season_1')
