...
class GDCRenderArnold(object):
    ...
    # 窗口
        ...
        mc.button(label=u'创建', bgc=[
                  0, 0, 0.0], width=110, height=30, command='from idmt.maya.pycommon import GDC_ArnoldCommon\nreload(GDC_ArnoldCommon)\nGDC_ArnoldCommon.GDCRenderArnold().ArnoldAOVCreat(AOVtype="AO")')
        mc.button(
            label=u'删除', bgc=[0, 0, 0.0], width=110, height=30, command='from idmt.maya.pycommon import GDC_ArnoldCommon\nreload(GDC_ArnoldCommon)\nGDC_ArnoldCommon.GDCRenderArnold().ArnoldAOVAODelete()')
...
#        collectionzdp = mc.radioCollection()
        ...
        mc.button(label=u'Arnold渲染设置', width=180, height=30,
                  bgc=[0.13, 0.6, 0.25], command='from idmt.maya.pycommon import GDC_ArnoldCommon\nreload(GDC_ArnoldCommon)\nGDC_ArnoldCommon.GDCRenderArnold().ArnoldRendererSettings("03")')         
        ...
        mc.button(label=u'输出角色id01',width=90,height=30,bgc=[0.13, 0.15, 0.25],command='from idmt.maya.pycommon import GDC_ArnoldCommon\nreload(GDC_ArnoldCommon)\nGDC_ArnoldCommon.GDCRenderArnold().csl_RGBInfoExport(id=\'id01\')')
        mc.button(label=u'输出角色id02',width=90,height=30,bgc=[0.13, 0.15, 0.25],command='from idmt.maya.pycommon import GDC_ArnoldCommon\nreload(GDC_ArnoldCommon)\nGDC_ArnoldCommon.GDCRenderArnold().csl_RGBInfoExport(id=\'id02\')')
        mc.button(label=u'输出角色id03',width=90,height=30,bgc=[0.13, 0.15, 0.25],command='from idmt.maya.pycommon import GDC_ArnoldCommon\nreload(GDC_ArnoldCommon)\nGDC_ArnoldCommon.GDCRenderArnold().csl_RGBInfoExport(id=\'id03\')') 
        mc.button(label=u'输出角色id04',width=90,height=30,bgc=[0.13, 0.15, 0.25],command='from idmt.maya.pycommon import GDC_ArnoldCommon\nreload(GDC_ArnoldCommon)\nGDC_ArnoldCommon.GDCRenderArnold().csl_RGBInfoExport(id=\'id04\')')                 
        mc.button(label=u'输出场景id11',width=90,height=30,bgc=[0.0, 0.0, 0.0],command='from idmt.maya.pycommon import GDC_ArnoldCommon\nreload(GDC_ArnoldCommon)\nGDC_ArnoldCommon.GDCRenderArnold().csl_RGBInfoExport(id=\'id11\')')
        mc.button(label=u'输出场景id12',width=90,height=30,bgc=[0.0, 0.0, 0.0],command='from idmt.maya.pycommon import GDC_ArnoldCommon\nreload(GDC_ArnoldCommon)\nGDC_ArnoldCommon.GDCRenderArnold().csl_RGBInfoExport(id=\'id12\')')
        mc.button(label=u'输出场景id13',width=90,height=30,bgc=[0.0, 0.0, 0.0],command='from idmt.maya.pycommon import GDC_ArnoldCommon\nreload(GDC_ArnoldCommon)\nGDC_ArnoldCommon.GDCRenderArnold().csl_RGBInfoExport(id=\'id13\')')        
        mc.button(label=u'输出场景id14',width=90,height=30,bgc=[0.0, 0.0, 0.0],command='from idmt.maya.pycommon import GDC_ArnoldCommon\nreload(GDC_ArnoldCommon)\nGDC_ArnoldCommon.GDCRenderArnold().csl_RGBInfoExport(id=\'id14\')')         
        mc.button(label=u'ID材质输出前检测',width=90,height=30,bgc=[0.1, 0.6, 0.25],command='from idmt.maya.pycommon import GDC_ArnoldCommon\nreload(GDC_ArnoldCommon)\nGDC_ArnoldCommon.GDCRenderArnold().csl_RGBInfoExportTest()')
        mc.setParent('..')
        mc.setParent('..')        
        #idp材质工具    
        mc.frameLayout(label=u'IDP材质工具', bgc=[0, 0, 0.0], borderStyle='in', cll=1,cl=1)
        mc.rowColumnLayout(numberOfColumns=4) 
        mc.button(label=u'R',width=90,height=30,bgc=[1,0,0],command='from idmt.maya.pycommon import GDC_ArnoldCommon\nreload(GDC_ArnoldCommon)\nGDC_ArnoldCommon.GDCRenderArnold().ArnoldRendererSettings("03")\nGDC_ArnoldCommon.GDCRenderArnold().ArnoldIDCreat(idpShader="ArnoldIdpR")')
        mc.button(label=u'G',width=90,height=30,bgc=[0,1,0],command='from idmt.maya.pycommon import GDC_ArnoldCommon\nreload(GDC_ArnoldCommon)\nGDC_ArnoldCommon.GDCRenderArnold().ArnoldRendererSettings("03")\nGDC_ArnoldCommon.GDCRenderArnold().ArnoldIDCreat(idpShader="ArnoldIdpG")')
        mc.button(label=u'B',width=90,height=30,bgc=[0,0,1],command='from idmt.maya.pycommon import GDC_ArnoldCommon\nreload(GDC_ArnoldCommon)\nGDC_ArnoldCommon.GDCRenderArnold().ArnoldRendererSettings("03")\nGDC_ArnoldCommon.GDCRenderArnold().ArnoldIDCreat(idpShader="ArnoldIdpB")')
        mc.button(label=u'M',width=90,height=30,bgc=[0,0,0],command='from idmt.maya.pycommon import GDC_ArnoldCommon\nreload(GDC_ArnoldCommon)\nGDC_ArnoldCommon.GDCRenderArnold().ArnoldRendererSettings("03")\nGDC_ArnoldCommon.GDCRenderArnold().ArnoldIDCreat(idpShader="ArnoldIdpM")')
        mc.button(label=u'Y',width=90,height=30,bgc=[1,1,0],command='from idmt.maya.pycommon import GDC_ArnoldCommon\nreload(GDC_ArnoldCommon)\nGDC_ArnoldCommon.GDCRenderArnold().ArnoldRendererSettings("03")\nGDC_ArnoldCommon.GDCRenderArnold().ArnoldIDCreat(idpShader="ArnoldIdpY")') 
        mc.button(label=u'C',width=90,height=30,bgc=[0,1,1],command='from idmt.maya.pycommon import GDC_ArnoldCommon\nreload(GDC_ArnoldCommon)\nGDC_ArnoldCommon.GDCRenderArnold().ArnoldRendererSettings("03")\nGDC_ArnoldCommon.GDCRenderArnold().ArnoldIDCreat(idpShader="ArnoldIdpC")') 
        mc.button(label=u'K',width=90,height=30,bgc=[1,0,1],command='from idmt.maya.pycommon import GDC_ArnoldCommon\nreload(GDC_ArnoldCommon)\nGDC_ArnoldCommon.GDCRenderArnold().ArnoldRendererSettings("03")\nGDC_ArnoldCommon.GDCRenderArnold().ArnoldIDCreat(idpShader="ArnoldIdpK")')                 
        mc.setParent('..')
        mc.setParent('..')        
        ...
        mc.button(label=u'Lam',width=90,height=30,bgc=[0.5,0.5,0.5],command='from idmt.maya.pycommon import GDC_ArnoldCommon\nreload(GDC_ArnoldCommon)\nGDC_ArnoldCommon.GDCRenderArnold().P5_ArnoldDisMatCreat(idpShader="ArnoldLambert")')
        mc.button(label=u'Occ',width=90,height=30,bgc=[1,1,1],command='from idmt.maya.pycommon import GDC_ArnoldCommon\nreload(GDC_ArnoldCommon)\nGDC_ArnoldCommon.GDCRenderArnold().P5_ArnoldDisMatCreat(idpShader="ArnoldOcc")')   
        mc.button(label=u'Normal',width=90,height=30,bgc=[0.4,0.55,0.9],command='from idmt.maya.pycommon import GDC_ArnoldCommon\nreload(GDC_ArnoldCommon)\nGDC_ArnoldCommon.GDCRenderArnold().P5_ArnoldDisMatCreat(idpShader="ArnoldNormal")')                       
        mc.setParent('..')        
