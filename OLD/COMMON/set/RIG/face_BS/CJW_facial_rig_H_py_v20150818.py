        ...
        if os.path.exists(TXTpath):        
            try:
                ...
                for ConnectionNode in ConnectionNodes:
                    ...
                    if 'CJW_selectPannel_selectDefaultSurfaceShaderSG' in mc.listConnections(SelectGuideShape,s=0,d=1,connections=1):
    ...
    def CJW_TextureWire(self):
        ...
        for SelectCtrl in AllSelectCtrls:
            ...
            if mc.objExists(SelectGuide):
                ...
                if not 'CJW_selectPannel_selectDefaultSurfaceShaderSG' in PreConnections:
                    if os.path.exists(TXTpath) and not PreConnections in OldConnectionNodes:
