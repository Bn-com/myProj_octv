...
//Name: High_eyeballs_rig.ma
//Last modified: Fri, Jan 08, 2016 09:13:17 AM
//Codeset: 936
requires maya "2014";
...
createNode transform -n "c_Lf_eye_M" -p "GRP_c_Lf_eye_M_inOut";
	addAttr -ci true -sn "sign" -ln "sign" -dv 73 -at "long";
	addAttr -ci true -sn "translateXWeight" -ln "translateXWeight" -nn "Translate X Weight" 
		-dv 1 -min 0 -max 10 -at "double";
	addAttr -ci true -sn "in_scale" -ln "in_scale" -at "double";
	addAttr -ci true -sn "out_scale" -ln "out_scale" -at "double";
	addAttr -ci true -sn "autoEyelidsFollow" -ln "autoEyelidsFollow" -min 0 -max 10 
		-at "double";
	setAttr -l on -k off ".v";
	...
	setAttr ".msxe" yes;
	setAttr ".xsxe" yes;
	setAttr -k on ".translateXWeight" 0;
	setAttr -cb on ".in_scale" 5;
	setAttr -cb on ".out_scale" 5;
	setAttr -k on ".autoEyelidsFollow";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -20.145645352343188 45.169112684476659 71.379141715757015 ;
	setAttr ".r" -type "double3" -21.338352729607585 -18.600000000001959 4.1947941183112787e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 74.194412388062631;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 5.2387068965517241 22.415421365825836 8.0000000000000018 ;
...
createNode hyperView -n "hyperView1";
	setAttr ".vl" -type "double2" -108.3333333333334 -554.16666666666686 ;
	setAttr ".vh" -type "double2" 860.71428571428578 32.738095238095227 ;
	setAttr ".dag" no;
...
createNode hyperView -n "hyperView3";
	setAttr ".vl" -type "double2" -263.52010259888499 -1483.5656839361229 ;
	setAttr ".vh" -type "double2" 1036.7500523383467 -434.06191602250021 ;
	setAttr ".dag" no;
createNode hyperLayout -n "hyperLayout3";
	setAttr ".ihi" 0;
	setAttr -s 8 ".hyp";
	setAttr ".hyp[0].x" 772.85711669921875;
	setAttr ".hyp[0].y" -421.42855834960937;
	setAttr ".hyp[0].nvs" 1921;
	setAttr ".hyp[1].x" 772.85711669921875;
	setAttr ".hyp[1].y" -691.4285888671875;
	setAttr ".hyp[1].nvs" 1920;
	setAttr ".hyp[2].x" 772.85711669921875;
	setAttr ".hyp[2].y" -980;
	setAttr ".hyp[2].nvs" 1921;
	setAttr ".hyp[3].x" 126.57974243164062;
	setAttr ".hyp[3].y" -431.39822387695312;
	setAttr ".hyp[3].nvs" 1922;
	setAttr ".hyp[4].x" 1.4285714626312256;
	setAttr ".hyp[4].y" -1055.7142333984375;
	setAttr ".hyp[4].nvs" 1920;
	setAttr ".hyp[5].x" 532.85711669921875;
	setAttr ".hyp[5].y" -1022.8571166992187;
	setAttr ".hyp[5].nvs" 1922;
	setAttr ".hyp[6].x" 532.85711669921875;
	setAttr ".hyp[6].y" -371.42855834960937;
	setAttr ".hyp[6].nvs" 1921;
	setAttr ".hyp[7].x" 772.85711669921875;
	setAttr ".hyp[7].y" -167.14285278320312;
	setAttr ".hyp[7].nvs" 1921;
	setAttr ".anf" yes;
createNode setRange -n "eyeBall_setRange";
	setAttr ".on" -type "float3" 0 -5 0 ;
	setAttr ".om" -type "float3" 5 0 0 ;
createNode multiplyDivide -n "eyeBall_multiplyDivide";
...
connectAttr "eyeBall_setRange.msg" "hyperLayout2.hyp[0].dn";
connectAttr "eyeBall_multiplyDivide.msg" "hyperLayout2.hyp[1].dn";
connectAttr "hyperView3.msg" "nodeEditorPanel3Info.b[0]";
connectAttr "hyperLayout3.msg" "hyperView3.hl";
connectAttr "GRP_c_Lf_eye_M_inOut.msg" "hyperLayout3.hyp[0].dn";
connectAttr "Rt_eye_M_loc.msg" "hyperLayout3.hyp[1].dn";
connectAttr "Lf_eye_M_loc.msg" "hyperLayout3.hyp[2].dn";
connectAttr "c_eye_M.msg" "hyperLayout3.hyp[3].dn";
connectAttr "c_eye_MShape.msg" "hyperLayout3.hyp[4].dn";
connectAttr "eyeBall_setRange.msg" "hyperLayout3.hyp[5].dn";
connectAttr "c_eye_M_inout_ex.msg" "hyperLayout3.hyp[6].dn";
connectAttr "GRP_c_Rt_eye_M_inOut.msg" "hyperLayout3.hyp[7].dn";
connectAttr "c_Lf_eye_M.translateXWeight" "eyeBall_setRange.mx";
connectAttr "c_eye_M.tx" "eyeBall_setRange.vx";
connectAttr "c_eye_M.tx" "eyeBall_setRange.vy";
connectAttr "eyeBall_multiplyDivide.oy" "eyeBall_setRange.ny";
connectAttr "c_Rt_eye_M.translateXWeight" "eyeBall_multiplyDivide.i1y";
...
connectAttr "eyeBall_setRange.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "eyeBall_multiplyDivide.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
// End of High_eyeballs_rig.ma
