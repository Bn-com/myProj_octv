...
def SK_createTwist(jntObj):
    ...
    wrist_MD = rig.listConnections(ikCon+'.scale',s = False,d = True,scn = True,type = 'multiplyDivide')[0]
    wristJnt = rig.listConnections(wrist_MD+'.output',s = False,d = True,scn = True,type = 'joint')[0]    
