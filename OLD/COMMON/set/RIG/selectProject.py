...
def edo_createLocation():
    ...
    try:
        cmds.sets(['LfArm_UpArm_FK_location','LfArm_Elbow_FK_location','LfArm_Wrist_FK_location','LfArm_wristMid_FK_location','LfArm_Pole_ctrl_location','LfArm_Wrist_IK_location'],rm='Lf_ArmSet')
    except:
        pass
    #RtArm
    ...
    try:
        cmds.sets(['RtArm_UpArm_FK_location','RtArm_Elbow_FK_location','RtArm_Wrist_FK_location','RtArm_wristMid_FK_location','RtArm_Pole_ctrl_location','RtArm_Wrist_IK_location'],rm='Rt_ArmSet')
    except:
        pass
    #LfLeg
    ...
    try:
        cmds.sets(['LfLeg_Leg_FK_location','LfLeg_Knee_FK_location','LfLeg_Ankle_FK_location','LfLegLeg_ball_FK_location','LfLeg_Pole_ctrl_location','LfLeg_Leg_IK_location'],rm='Lf_LegSet')
    except:
        pass
    #RtLeg
    ...
    try:
        cmds.sets(['RtLeg_Leg_FK_location','RtLeg_Knee_FK_location','RtLeg_Ankle_FK_location','RtLegLeg_ball_FK_location','RtLeg_Pole_ctrl_location','RtLeg_Leg_IK_location'],rm='Rt_LegSet')
    except:
        pass        
#===============================================================================
# 选择配置
