...
class check_toolbox_gdc():
    ...
    def check_calimero_shading(self, scenePathName, modelType, error_type):
        ...
        for colorID in colorIDs:
            ...
            if not (colorR == 1.0 and colorG == 0.0 and colorB == 0.0) and not (colorR == 0.0 and colorG == 1.0 and colorB == 0.0) and not (colorR == 0.0 and colorG == 0.0 and colorB == 1.0) and not (colorR == 0.0 and colorG == 0.0 and colorB == 0.0):
