...
execfile(bodyrigpath+'selectProject.py')
execfile(bodyrigpath+'edo_ikfkSwitch.py')
...
def edo_motionBuilderControlGdcRigCmd():
    ...
    filepath=bodyrigpath+'template/HUMANIK_TO_GDCRIG.mb'    #mel.eval('HIKSkeletonGenerator;')
