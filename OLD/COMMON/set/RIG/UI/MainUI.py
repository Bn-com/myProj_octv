...
import RIG.selectJoint as selectJoint
from RIG.commonly.bodyTemplate import SK_BodyJointPosition
#import RIG.commonly.bodyTemplate as bodyTemplate
from RIG.commonly.restoreJoint import *
#import RIG.commonly.restoreJoint  as restoreJoint 
from RIG.fingerPose import *
#import RIG.fingerPose as fingerPose
from RIG.commonly.base import *
#import RIG.commonly.base as base

from RIG.commonly.mirrorCurve import SK_MirrorCurveControlCmd
#import RIG.commonly.mirrorCurve as mirrorCurve
...
class SK_IDMTRigUI(object):
    ...
    def displayUI(self):
        ...
        self.MainWindow = rig.window(IDMTRigGUI,title=u'IDMT 2014 AutoRig(表情插件更新中...)',menuBar=True,wh=  (400,780),minimizeButton=True,maximizeButton=True)
...
def SK_rigSkin():
    jnts = selectJoint.SK_selectSkinJnt()
    rig.select(cl = True)
