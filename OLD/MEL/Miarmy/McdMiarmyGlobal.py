        ...
        for j in range(len(allChild)):
            if allChild[j].find("OriginalAgent") >= 0:
                ...
                if firstBone != "" and not MIsBlank(firstBone):
                    ...
                    # progress window
                    cmds.progressWindow( title = "Creating", progress = 0, \
                                       min = 0, \
                                       max = len(orgBones), \
                                       status = str(i+1) + " of " + str(len(allAgtGrp)), isInterruptable = True )
                    ...
                    for k in range(len(orgBones)):
                        ...
                        cmds.progressWindow( edit = True, progress = k)
