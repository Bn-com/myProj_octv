...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        QtCore.QObject.connect(self.chbx_oth, QtCore.SIGNAL("toggled(bool)"), self.rb_old.setDisabled)
        QtCore.QObject.connect(self.rb_old, QtCore.SIGNAL("toggled(bool)"), self.chbx_oth.setDisabled)
