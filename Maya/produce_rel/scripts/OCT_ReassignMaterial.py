...
class OCT_ReassignMatUI(object):
    def __init__(self):
        self._dst_shd_dict = {}
    ...
    def call_ui():
        ...
        listSrcSdCmdStr = 'ins_rs = OCT_ReassignMatUI()\nins_rs.lfbt_cmd()'
    ...
    def list_AllShaders(self, specObj, ignorID=False):
        ...
        if specObj.type != 'mesh': specObj = specObj.getShape()
    ...
    def sel_item_cmd(self, type='src'):
        ...
        if type == 'dst':
            ...
            mc.textFieldGrp('keywordTFG',e=True,text=OCT_ReassignMatUI.autoFindKeywords(sel_lable[0]))
    ...
    def Reassing_btcmd(self):
        ...
        if mc.checkBox('allcb', q=True, value=True):
            ...
            for each in othObjs:
                ...
                # kw = OCT_ReassignMatUI.autoFindKeywords(dst_shd[0])
    ...
    def auto_reassign():
        ...
        src_obj = selObjs[0]
        src_sds = OCT_ReassignMatUI.list_AllShaders(selObjs[0])
        des_objs = selObjs[1:]
